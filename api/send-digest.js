...
const DEEP_DIVES_NEW = [
  ...
  {
    title: "George Steinbrenner: The Boss, the Bully, and the Man Who Made the Yankees the Yankees Again",
    team: "Yankees",
    charity: "New York Yankees Foundation | yankees.com/community", year: 1973,
    body: "He was born on the Fourth of July. Not as a metaphor, not as something a sportswriter invented after the fact — George Michael Steinbrenner III actually entered the world on July 4, 1930, in Rocky River, Ohio, near Cleveland, the only son of a demanding shipping magnate who once publicly scolded his twelve-year-old boy for finishing second in a track meet. Henry Steinbrenner did not give his children allowances. Instead, he gave George chickens and told him to figure it out. By age nine, the kid had a functioning egg-delivery business. By age 80, he had turned a $10 million purchase into the most valuable franchise in professional sports. If you wanted to understand George Steinbrenner — and plenty of people spent careers trying — you could start with the birthday, the chickens, and the father who thought second place was an insult.\n\nThe country and Steinbrenner were, in a specific sense, the same age in temperament if not in years. He wore the American flag on his sleeve literally and figuratively, was fiercely patriotic in the way that people from his generation and background were — not performatively but genuinely, as a first principle. He loved the military, loved the Olympics, loved the idea of American excellence applied to American sport. He was also impulsive, grandiose, occasionally cruel, and incapable of staying out of his own way. In the summer of 2026, with the country celebrating its 250th birthday, it is worth revisiting what George Steinbrenner actually was — because the full picture, warts and all, is far more interesting than either the caricature of the tyrant or the rehabilitation of the legend.\n\n**THE OHIO KID WHO WANTED THE INDIANS**\n\nGeorge Steinbrenner did not set out to own the New York Yankees. He set out to own the Cleveland Indians — the team from his hometown, the team he had grown up near, the team that would have meant something specifically personal rather than merely enormous. In 1972, he was part of a partnership that tried to buy the Indians from owner Vernon Stouffer. The deal fell through. Stouffer ultimately decided not to sell, and Steinbrenner — who had spent years building the American Shipbuilding Company into a real business, coaching football at Northwestern and Purdue, buying and losing a basketball franchise in the short-lived American Basketball League — was left without a team.\n\nWhat happened next is the kind of pivot that seems inevitable only in retrospect. CBS had purchased the Yankees in 1964 for $13.2 million, installed suits who didn't understand baseball, and watched the franchise — which had won five consecutive American League pennants immediately before the sale — become a mediocre, money-losing embarrassment. By 1972, CBS chairman William Paley told team president Mike Burke the company wanted out. Burke went looking for buyers. A baseball executive named Gabe Paul introduced Burke to Steinbrenner. On January 3, 1973, Steinbrenner and a group of investors purchased the New York Yankees from CBS for $10 million — effectively $8.8 million once CBS bought back two parking garages that had been bundled into the deal. In today's dollars, roughly $75 million for the most famous sports franchise in America. It was, as history would confirm, the greatest bargain in the history of professional sports.\n\n\"I won't be active in the day-to-day operations of the club at all,\" Steinbrenner announced. \"I can't spread myself so thin. I've got enough headaches with my shipping company.\"\n\nHe then walked into Yankee Stadium, saw freshly cut flowers on every desk in the front office, and immediately began firing people. The flowers, apparently, were the last straw.\n\n**THE FREE AGENCY REVOLUTION**\n\nWhat saved George Steinbrenner — at least in the first act — was timing. He bought the Yankees in 1973, and free agency arrived in baseball in 1976, the result of the Messersmith-McNally arbitration ruling that ended the reserve clause and allowed players to negotiate their own futures. The Yankees, under Steinbrenner, understood immediately what this meant and moved accordingly. In December 1974, before free agency had even officially begun, Steinbrenner pulled off a remarkable move: he signed pitcher Catfish Hunter, whose contract with the Oakland A's had been voided on a technicality, making Hunter the first major star to test something close to the open market. The Yankees gave him $3.75 million over five years — roughly $27 million in today's dollars, and triple what any player in baseball was earning at the time. It was the richest contract in baseball history, and it sent a message to every owner and every player in the sport simultaneously.\n\nThe message was sent. When true free agency arrived two years later, Steinbrenner was ready. He signed Reggie Jackson in November 1976 — five years, nearly $3 million, roughly equivalent to $19 million today — after a courtship that Jackson later described as Steinbrenner making him feel like the most important person in the world. He wasn't wrong to feel that way, exactly. Steinbrenner's genius in those early years was his complete willingness to spend what nobody else would spend, to treat baseball salaries not as a budget constraint but as a competitive weapon. Critics said he was buying championships. He was, in fact, buying championships. And he wasn't apologetic about it.\n\nThe Catfish Hunter signing and the Reggie Jackson signing changed baseball economics permanently. Other owners were forced to compete, player salaries across the sport accelerated, and the relationship between ownership and labor was transformed in ways that are still playing out today. Steinbrenner did not cause free agency — Marvin Miller and the Players Association did — but he was its most aggressive early adopter, and the game would never be the same.\n\n**THE BRONX ZOO**\n\nThe championships came — 1977 and 1978, back-to-back World Series titles — but what people remember from those years almost as vividly as the wins is the atmosphere surrounding them. \"The Bronx Zoo\" was not a nickname someone invented affectionately. It was a real description of a real situation. The principal animals in the zoo were George Steinbrenner, Reggie Jackson, and Billy Martin, a combination that produced more front-page news in two years than most franchises generate in a decade.\n\nBilly Martin was Steinbrenner's great obsession and his greatest managerial relationship. Martin had played for the Yankees in the 1950s, was beloved by Yankee fans, managed with an intensity and tactical intelligence that Steinbrenner recognized as his own, and was constitutionally incapable of keeping his job. Steinbrenner hired and fired Martin five separate times. Five times. The relationship was described by those inside it as something between a marriage and a hostage situation — genuine affection, real respect, total dysfunction. When Martin, after his first firing in 1978, was asked to assess his former boss and his star player, he offered the most celebrated line in Yankee history: \"One's a born liar, the other's convicted.\" He was referring to Jackson and Steinbrenner, though accounts vary on which was which.\n\nThe manager carousel in those years was something else entirely. In his first 23 seasons as owner, Steinbrenner changed the Yankee manager 20 times. Twenty. He fired Dick Howser after the 1980 season — Howser had just won 103 games and the AL East — apparently because Howser resisted Steinbrenner's interference in on-field decisions. He fired Yogi Berra 16 games into the 1985 season, delivering the news through a messenger rather than in person, which prompted Berra to vow he would not set foot in Yankee Stadium again as long as Steinbrenner ran the team. He kept the vow for 14 years. He hired Bob Lemon twice, including once specifically to replace Martin mid-season in 1978, which helped the Yankees complete a 14-game comeback against the Red Sox and win the World Series — a rare case of a managerial firing that demonstrably produced a championship.\n\nGraig Nettles, the Yankees' third baseman through those years, summarized it with a line that became famous: \"When I was a little boy, I wanted to be a baseball player and join the circus. With the Yankees, I've accomplished both.\"\n\n**THE WARTS: SUSPENSION NUMBER ONE**\n\nBefore any of the 1977 and 1978 championships, before Catfish Hunter and Reggie Jackson, there was a problem that Steinbrenner had brought with him from his previous life. In the run-up to the 1972 presidential election, Steinbrenner had funneled $75,000 in illegal contributions to Richard Nixon's campaign committee — partly, he later said, to protect his shipping company from federal antitrust scrutiny, partly because that was simply how business worked in the world he came from. He had his employees give $25,000 in bonuses with the explicit understanding that the money would be donated to Nixon, then tried to cover it up. In April 1974 — one day before the Yankees' Opening Day — he was indicted on 14 criminal counts. He pleaded guilty to making illegal campaign contributions and was fined $15,000.\n\nCommissioner Bowie Kuhn suspended Steinbrenner from baseball for two years. The suspension was later reduced to 15 months, and Steinbrenner returned in time to oversee the free agency revolution and the back-to-back championships that followed. Ronald Reagan, in one of his final acts as president in 1989, issued Steinbrenner a full pardon. The pardon, it emerged years later, had been partly facilitated by Steinbrenner's undisclosed assistance to the FBI on what the bureau described as \"two national security matters\" and \"a sensitive security matter involving terrorism\" between 1978 and 1983. Steinbrenner had apparently placed his family at some risk to cooperate, though the specifics remain classified. The Boss contained multitudes.\n\n**THE WINFIELD YEARS AND SUSPENSION NUMBER TWO**\n\nThe 1980s were, by any objective measure, the strangest and most self-destructive decade of Steinbrenner's ownership. He signed Dave Winfield in 1980 to a 10-year contract that turned out to be worth $23 million due to a cost-of-living escalator his agent had inserted — a clause Steinbrenner apparently hadn't fully understood when he signed it. That $23 million is worth roughly $109 million in today's dollars. For context: Winfield's deal was the largest in baseball history when signed, and it made him the most expensive player in the sport at a time when most players were making a fraction of that. He spent the next decade furious about it. \"I let Mr. October get away, and I got Mr. May, Dave Winfield,\" he said in 1985, a reference to Reggie Jackson and a characterization of Winfield as a man who produced in the regular season and disappeared in October. It was both petty and inaccurate — Winfield was a legitimate Hall of Famer who had his numbers suppressed by playing in Yankee Stadium's vast outfield dimensions — but Steinbrenner committed to it with his usual thoroughness.\n\nThe Yankees of the 1980s spent extravagantly and accomplished almost nothing. They made the World Series in 1981 and lost it to the Dodgers in six games, after which Steinbrenner held a press conference in his Los Angeles hotel room to display injuries he claimed to have sustained in a fight with Dodgers fans in the elevator. (The elevator fight story has never been corroborated by anyone else who was present.) He then issued a public apology to the people of New York for the team's performance, which nobody had asked for, and which Yankee fans found more embarrassing than the loss itself. The 1980s otherwise produced no championships, heavy spending, and an atmosphere in the organization that made it nearly impossible to develop and keep good young players.\n\nThe decade bottomed out in 1990, when Steinbrenner's war with Winfield finally destroyed him entirely. Winfield had been suing the Yankees for failing to contribute to his charitable foundation as required by his contract. Steinbrenner, desperate to find something damaging about Winfield, paid a small-time gambler named Howard Spira $40,000 — roughly $114,000 in today's money — to dig up dirt on the outfielder. It was a squalid, mean, and ultimately self-defeating move — Spira extorted Steinbrenner for more money, Steinbrenner turned him over to the FBI, and the investigation that followed uncovered not wrongdoing by Winfield but wrongdoing by Steinbrenner. On July 30, 1990, Commissioner Fay Vincent banned Steinbrenner from the day-to-day operations of the Yankees.\n\nHere is the detail that almost nobody knows: Steinbrenner was not technically \"suspended.\" He voluntarily agreed to step away, and the distinction mattered to him intensely — because a formal suspension would have jeopardized his position as vice president of the United States Olympic Committee, a role he had coveted and worked for and was genuinely proud of. The Boss, who had spent years publicly declaring his love of country and his commitment to American athletic excellence, accepted a permanent exile from baseball partly to protect his Olympic committee seat. He was reinstated by the next commissioner, Bud Selig, in March 1993. The \"lifetime ban\" had lasted about two and a half years.\n\n**THE GIFT OF GETTING OUT OF THE WAY**\n\nWhat happened while Steinbrenner was gone is one of the great unintentional gifts in baseball history.\n\nWith the owner sidelined, general manager Gene Michael — known throughout the organization as \"Stick\" — was free to operate without interference for the first time. Michael had been around the Yankees for years, had watched Steinbrenner's meddling derail promising players and front offices, and had a clear, specific vision for what the organization needed to do: stop trading prospects for proven veterans, develop players from within, and build a foundation that could sustain multiple championship runs rather than perpetually chasing the next big free-agent name.\n\nThe players Michael developed or retained during Steinbrenner's absence are not hard to identify. Derek Jeter, drafted in 1992. Jorge Posada, drafted in 1990. Andy Pettitte, drafted in 1990. Mariano Rivera, signed out of Panama in 1990. Bernie Williams, signed in 1985 but protected by Michael when previous regimes had been willing to trade him. The Core Four was built almost entirely in the years Steinbrenner was too distracted or too constrained to interfere. Michael later said he had to hide some of these players from Steinbrenner even after his return, keeping them out of trade conversations by convincing the owner their value wasn't high enough to make a deal worthwhile.\n\nWhen Steinbrenner returned in 1993, he came back to a team that was quietly becoming excellent, managed by a front office that had finally been allowed to operate rationally for a couple of years. He hired Joe Torre as manager in 1995 — a decision that was widely mocked at the time, because Torre had never won anything as a manager — and then, remarkably, left Torre and the front office largely alone. The Yankees won the World Series in 1996. Then in 1998 with 125 total wins. Then 1999. Then 2000. Four championships in five years, 13 consecutive playoff appearances, a dynasty built precisely because a man who couldn't stop controlling things had been forced to stop controlling things, and the organization had quietly become brilliant in the silence.\n\n**THE SECOND CHANCES**\n\nOne of the most consistent — and least publicized — aspects of Steinbrenner's character was his willingness to give players second chances that nobody else would offer. This wasn't strategy or public relations. It was, by most accounts, genuine.\n\nWhen Darryl Strawberry's career appeared to be over in 1995 — after cocaine suspensions, legal problems, and a stint in independent ball with the St. Paul Saints — Steinbrenner signed him anyway. He did more than sign him: he appointed a full-time guardian to shadow Strawberry at all times, arranged for regular drug testing, and supported his rehabilitation with organizational resources that went well beyond what a utility outfielder warranted. Strawberry repaid him by hitting 11 home runs in 63 games for the 1996 championship team, blasting three home runs in the ALCS against Baltimore, and winning his second World Series ring.\n\nWhen Dwight Gooden's career appeared to be over in 1996 — after his own drug suspension cost him the entire 1995 season, and the Mets who had made him a legend declined to re-sign him — Steinbrenner brought him to the Yankees. On May 14, 1996, Gooden threw a no-hitter against the Seattle Mariners. It was, by his own account, the greatest single night of his career. He had not pitched in the major leagues in nearly two years. He was 31 years old. Steinbrenner gave him that.\n\nThese were not isolated cases. Steve Howe, a relief pitcher with seven MLB drug-related suspensions, got multiple chances in the Bronx. Steinbrenner's charitable giving — to inner-city youth programs, to military families, to individual people who were struggling and reached out to him — was extensive and almost entirely private. The Boss who humiliated managers on the back pages of the Daily News and the Post made anonymous contributions to pay funeral expenses for people he had never met. Both things were equally true.\n\n**THE OLYMPIC PRIDE**\n\nOne of the chapters of Steinbrenner's life that tends to get lost in the baseball biography is his genuine commitment to American Olympic competition. He was vice president of the United States Olympic Committee for years, took real pride in the role, and worked to support American athletes in ways that had nothing to do with his own business interests. His relationship with the Olympics was a thread that ran through his entire adult life — he had been a track athlete himself at Williams College, had the competitive temperament of someone who had always measured himself against others, and genuinely cared about American athletes representing the country on the world stage. When the choice in 1990 came down to his baseball career versus his Olympic position, it tells you something that protecting the Olympic role was a serious enough consideration to shape how he structured his exit.\n\n**THE END**\n\nGeorge Steinbrenner died on July 13, 2010 — the same day as the Major League Baseball All-Star Game, and two days after the death of Bob Sheppard, the Yankees' public address announcer for 57 years. He was 80 years old. He had suffered a major heart attack in Tampa. The Yankees wore a patch honoring both Steinbrenner and Sheppard for the remainder of that season. A monument was added to Monument Park in September 2010.\n\nHe had bought the Yankees for $10 million in 1973 — about $75 million in today's money. The franchise was valued at approximately $1.6 billion at the time of his death in 2010 — roughly $2.3 billion in today's dollars, the first North American sports franchise to break the billion-dollar barrier. Put another way: he paid $75 million in real terms and built something worth $2.3 billion. A 30-to-1 return, built on shipping money, free agency, and an inability to accept losing. He had overseen seven World Series championships and 11 American League pennants in 37 years of ownership — the longest in franchise history, even counting the suspension years.\n\nBilly Martin had died in a car accident on Christmas Day 1989, long before any reconciliation was possible, and Steinbrenner attended the funeral. Yogi Berra finally came back to Yankee Stadium in 1999, after 14 years, when Steinbrenner made a personal trip to Yogi's museum in Montclair, New Jersey to apologize directly. Berra, famously not a man for elaborate speeches, accepted the apology and came back. Dave Winfield went into the Hall of Fame as a San Diego Padre — the team name on his plaque is not a Yankee — and then later made a kind of peace with Steinbrenner in the years before his death.\n\nThe Boss wanted his tombstone to read, simply, \"a guy who never stopped trying.\" He didn't get to choose his tombstone text, but the sentiment is accurate. He tried everything — some of it brilliant, some of it catastrophic, and almost all of it conducted at full volume. He was born on the Fourth of July, wore the flag like a second skin, and bought the most American team in the most American city and made it great again, twice, through a combination of will and cash and fury and, when he was finally forced to be quiet, through the talent of the people he had hired and then gotten out of the way of.\n\nThe good, the bad, and the ugly are inseparable. You don't get the Core Four without the suspension. You don't get the suspension without the Winfield feud. You don't get the Winfield feud without the obsession with winning that also brought Catfish Hunter and Reggie Jackson and the 1977 and 1978 championships. You don't get any of it without a kid from Bay Village, Ohio who got shut out of buying the Cleveland Indians in 1972 and turned his attention, almost accidentally, to the Bronx.\n\nNew York got lucky that Vernon Stouffer didn't sell. Cleveland probably doesn't know how lucky it got too."
  },
...
// ── WEDNESDAY: NY SPORTS DEBATES ────────────────────────────────────────────
const NY_DEBATES = [
  { week:1, topic:"Judge's 62 vs DiMaggio's 56", question:"Which NY number matters more to baseball history?", sideA:"Judge's 62", caseA:"Aaron Judge hit 62 home runs in 2022 — clean, undisputed, no asterisk, the legitimate American League record. He did it in the modern era against the best pitching in history, while playing center field, batting leadoff, and competing for a Triple Crown simultaneously. The Bonds/McGwire/Sosa era inflated numbers hang over everything above 62. Judge's number doesn't. It stands alone.", sideB:"DiMaggio's 56", caseB:"Joe DiMaggio hit safely in 56 consecutive games in 1941 — and in 85 years since, nobody has come within 12 games of it. Judge's 62 broke a record that had already been broken twice by steroid-era players. DiMaggio's 56 has never been seriously threatened. One number gets closer every decade. The other gets more untouchable every year.", teams:"Yankees" },
  { week:2, topic:"1927 Yankees vs 1998 Yankees", question:"Greatest baseball team ever — which one?", sideA:"1927 Yankees", caseA:"The 1927 New York Yankees won 110 games, swept the World Series, and featured Babe Ruth hitting 60 home runs and Lou Gehrig driving in 175. They played in an era when the home run was still a novelty, and they redefined what a baseball team could look like. Murderers' Row. The standard against which every team since has been measured.", sideB:"1998 Yankees", caseB:"The 1998 Yankees won 114 regular season games and 125 total including playoffs — sweeping three different opponents in the postseason. They had no weaknesses: David Cone, David Wells (who threw a perfect game), Rivera closing, Jeter leading. The '27 Yankees played a 154-game schedule against segregated competition. The '98 team beat the best in the world, in a 162-game season, with a margin that has never been replicated.", teams:"Yankees" },
  { week:3, topic:"Tom Seaver vs Jacob deGrom", question:"Greatest Mets pitcher ever?", sideA:"Tom Seaver", caseA:"Tom Seaver won three Cy Young Awards, went 25-7 in 1969, and saved the Mets franchise from irrelevance during their early years. He was The Franchise — the single player who made the Mets a legitimate baseball organization. He pitched 20 seasons and won 311 games. deGrom was better for two years. Seaver was great for two decades.", sideB:"Jacob deGrom", caseB:"In 2018 and 2019, Jacob deGrom had arguably the two most dominant consecutive pitching seasons in the history of the sport — back-to-back Cy Young Awards, a 1.70 ERA across two full seasons, historically efficient. His ERA in 2018 was 1.70 while his team scored him fewer than 2 runs per start. Seaver was great. deGrom, at his peak, was something that had never been seen before.", teams:"Mets" },
  { week:4, topic:"Derek Jeter vs Alex Rodriguez", question:"Who meant more to the Yankees dynasty?", sideA:"Derek Jeter", caseA:"Derek Jeter won five World Series championships, made 14 All-Star teams, and defined what it meant to be a New York Yankee for 20 years. He never played a game in another uniform. He won a Gold Glove at shortstop, led the team in the postseason on the biggest stages, and was named captain. The cultural weight of Jeter's career — what he meant to the city, to the brand, to the franchise — is impossible to separate from the baseball.", sideB:"Alex Rodriguez", caseB:"Alex Rodriguez won three AL MVP awards, hit 696 career home runs, and was statistically the most productive hitter in Yankees history other than Ruth and Gehrig. For most of his career, he was simply the best player in baseball. Jeter had five rings. A-Rod won one with the Yankees in 2009 and was the best player on that team. The argument that Jeter meant more is a cultural argument. The argument that A-Rod was better is a baseball argument. Both are right.", teams:"Yankees" },
  { week:5, topic:"1969 Mets vs 1986 Mets", question:"Greater championship team?", sideA:"1969 Miracle Mets", caseA:"The 1969 Mets were 100-to-1 longshots in April, nine and a half games back in August, and World Series champions in October. They beat the Baltimore Orioles — who had won 109 games — in five games. No upset in baseball history has come close. The 1986 Mets were dominant. The 1969 Mets were impossible.", sideB:"1986 Mets", caseB:"The 1986 Mets won 108 games, had the greatest pitching staff in the National League, and won one of the most dramatic World Series ever played. Dwight Gooden, Darryl Strawberry, Keith Hernandez, Gary Carter, Mookie Wilson — a team that dominated from April through October. Game 6 against Boston is the most replayed game in Mets history. The 1969 Mets were miraculous. The 1986 Mets were simply the best team in baseball.", teams:"Mets" },
  { week:6, topic:"Mike Piazza vs Gary Carter", question:"Greatest Mets catcher?", sideA:"Mike Piazza", caseA:"Mike Piazza hit .308 with 427 home runs in his career — the most by any catcher in baseball history. His 9/11 home run on September 21, 2001 may be the most emotionally significant hit in Mets history. He transformed the franchise from the moment he arrived and played his best years in blue and orange. No Mets offensive player has ever been more dangerous.", sideB:"Gary Carter", caseB:"Gary Carter was the heart of the 1986 championship team — the catcher who called the game, handled the pitching staff, and delivered in the postseason when it mattered most. His two-out single in the bottom of the tenth in Game 6 of the 1986 World Series started the rally. Carter was the emotional leader of the best Mets team ever assembled. Piazza was a greater offensive player. Carter was a greater winner.", teams:"Mets" },
  { week:7, topic:"Ruth 60 vs Maris 61 vs Judge 62", question:"Which Yankees single-season HR record stands alone?", sideA:"Ruth's 60", caseA:"Babe Ruth hit 60 home runs in 1927 in a 154-game season — at a time when nobody else in baseball hit more than 30. He didn't just break the record; he lapped the field. Ruth's 60 didn't just set a standard; it invented one. Every conversation about the home run record begins with the Babe, because he built the stage everyone else performs on.", sideB:"Judge's 62", caseB:"Judge's 62 is the only number in this conversation with no asterisk, no era caveat, no steroid shadow. Ruth's 60 was in 154 games. Maris's 61 had the commissioner's asterisk for years. The Bonds-McGwire numbers carry their own baggage. Judge's 62 is clean — the legitimate, undisputed American League record, set in the modern era against the best pitching in history.", teams:"Yankees" },
  { week:8, topic:"Babe Ruth vs Mickey Mantle", question:"Greatest Yankee ever?", sideA:"Babe Ruth", caseA:"Babe Ruth hit 714 career home runs, won four World Series as a Yankee, and transformed baseball so completely that the sport before him and after him are essentially different games. He was the greatest pitcher in the AL before he became the greatest hitter in the history of the sport. No athlete in any American sport changed their game as completely as Ruth changed baseball.", sideB:"Mickey Mantle", caseB:"Mickey Mantle played his entire career on a knee that was never fully right after a 1951 injury — and was still the best player in baseball for most of the 1950s and 1960s. His Triple Crown season in 1956, his back-to-back MVP awards, his 536 career home runs, all of it accomplished while playing through pain that would have ended most careers. The number Mantle would have put up healthy is the most tantalizing hypothetical in baseball history.", teams:"Yankees" },
  { week:9, topic:"Darryl Strawberry vs David Wright", question:"Greatest position player in Mets history?", sideA:"Darryl Strawberry", caseA:"Darryl Strawberry was the first overall pick in 1980, made eight All-Star teams as a Met, and was the most physically gifted outfielder the franchise has ever produced. His combination of power, speed, and arm was genuinely rare. In 1986, he was the cleanup hitter on the best Mets team ever assembled. The talent was transcendent.", sideB:"David Wright", caseB:"David Wright played 14 seasons for the Mets, spent his final years unable to walk without pain, and refused to leave. He is the franchise's all-time leader in hits, RBI, runs, and total bases. He held himself to a professional standard that made him the most beloved Met of his generation. Strawberry had more raw talent. Wright had more character. In New York, that matters.", teams:"Mets" },
  { week:10, topic:"Shea Stadium vs Citi Field", question:"Better home for the Mets?", sideA:"Shea Stadium", caseA:"Shea Stadium was loud, chaotic, windswept, and completely alive. The Beatles played there in 1965 — the first stadium rock concert in history. Tom Seaver pitched there. The 1969 and 1986 championships were won there. The 9/11 home run happened there. The sightlines were bad and the seats were uncomfortable and it was the most New York baseball experience you could have.", sideB:"Citi Field", caseB:"Citi Field has better sightlines, better food, better infrastructure, and a design that actually respects the history of the franchise. The Jackie Robinson Rotunda is one of the most beautiful entrances in baseball. The park plays fair and the dimensions suit the game. Nostalgia is powerful, but Shea was objectively a difficult place to watch baseball.", teams:"Mets" },
  { week:11, topic:"Reggie Jackson vs Yogi Berra", question:"Greater World Series performer in NY?", sideA:"Reggie Jackson", caseA:"Reggie Jackson hit three home runs on three consecutive pitches from three different pitchers in Game 6 of the 1977 World Series. It is the single greatest individual performance in World Series history. Mr. October is not a nickname — it is a documented, statistical, historical fact. No player has ever performed better on the biggest stage in the sport's history.", sideB:"Yogi Berra", caseB:"Yogi Berra played in 14 World Series and won 10. He hit .361 with 12 home runs and 39 RBIs in Fall Classic play — the best overall World Series career in baseball history. Reggie had one transcendent game. Yogi was transcendent across 14 series, over two decades, as the backbone of the most successful dynasty in the history of the sport.", teams:"Yankees" },
  { week:12, topic:"Seaver trade vs deGrom departure", question:"Bigger Mets front office failure?", sideA:"Seaver 1977 trade", caseA:"The Mets traded Tom Seaver to Cincinnati in 1977 over a dispute about a contract offer reported in a newspaper column — a miscommunication that cost the franchise its greatest player. Seaver won 21 games for the Reds that year. The Mets finished last. They traded The Franchise for nothing and spent years rebuilding what they had casually given away.", sideB:"deGrom 2022 departure", caseB:"Jacob deGrom left for Texas as a free agent in 2022 after the Mets failed to sign him. He had just won back-to-back Cy Young Awards. The Mets let the best pitcher in baseball walk. The difference: deGrom made a choice. Seaver was pushed out. But the result — the best pitcher in Mets history gone before his time — is identical.", teams:"Mets" },
  { week:13, topic:"Patrick Ewing vs Jalen Brunson", question:"Greatest Knick ever when it's all said and done?", sideA:"Patrick Ewing", caseA:"Patrick Ewing played 15 seasons for the Knicks, made 11 All-Star teams, and carried the franchise through two decades of basketball. He came heartbreakingly close to a championship in 1994 — a loss that wasn't his fault. He defined New York basketball for an entire generation. The city loved him unconditionally and completely.", sideB:"Jalen Brunson", caseB:"Jalen Brunson arrived in 2022 as a second-round pick people laughed at, took $113 million less than he could have earned to help build the roster, and won the championship unanimously as Finals MVP in 2026. Ewing was the greatest Knick who never won. Brunson is the greatest Knick who did. The argument depends entirely on whether winning is the only thing that matters.", teams:"Knicks" },
  { week:14, topic:"1970 Knicks vs 2026 Knicks", question:"Better championship team?", sideA:"1970 Knicks", caseA:"The 1970 Knicks were a team of pure basketball — Reed, Frazier, DeBusschere, Bradley, Monroe. Red Holzman's system produced 18 assists per game and a defensive intensity that defined an era. Willis Reed limping out of the tunnel before Game 7 is the most iconic moment in franchise history. They were beautiful to watch and impossible to stop.", sideB:"2026 Knicks", caseB:"The 2026 Knicks outscored playoff opponents by 271 points across 14 games entering the Finals — the largest margin in NBA postseason history. They won 13 straight, authored the largest comeback in Finals history, and closed it out in San Antonio against a generational talent in Wembanyama. The 1970 team was more elegant. The 2026 team was more dominant.", teams:"Knicks" },
  { week:15, topic:"Willis Reed limping out vs Brunson's 45", question:"Greatest single Knicks moment?", sideA:"Willis Reed limping out", caseA:"Before Game 7 of the 1970 NBA Finals, nobody knew if Willis Reed could walk. When he came out of the tunnel at Madison Square Garden, the building erupted. He hit the first two baskets of the game — the only two points he would score — and the Knicks won the championship. It is the most iconic scene in franchise history and one of the most iconic in all of sports.", sideB:"Brunson's 45", caseB:"On June 13, 2026, on the road in San Antonio, with the Knicks trailing in the third quarter of a title-clinching game, Jalen Brunson scored 45 points — 13 of them in an uninterrupted fourth-quarter stretch — and ended 53 years of waiting. Reed's moment was about inspiration. Brunson's was about performance, sustained and relentless, for 48 minutes on the biggest stage.", teams:"Knicks" },
  { week:16, topic:"Walt Frazier vs Jalen Brunson", question:"Greatest Knicks guard ever?", sideA:"Walt Frazier", caseA:"Walt Frazier averaged 36 points and 19 assists in Game 7 of the 1970 NBA Finals while Willis Reed absorbed all the attention — the most complete performance in Knicks championship history. Clyde was a two-time champion, a fashion icon, and the most elegant defender of his era. He defined cool in New York before it was a category athletes aspired to.", sideB:"Jalen Brunson", caseB:"Jalen Brunson was the unanimous MVP of the 2026 NBA Finals. He had nine 30-point games in a single postseason, averaged 34 points in the Finals, and scored 45 in the clincher. He is 6-foot-2 — the second-shortest Finals MVP in history — and he took $113 million less than market value to win. Frazier was a champion. Brunson is a champion who did something Frazier never quite finished.", teams:"Knicks" },
  { week:17, topic:"1994 Knicks Finals loss vs 1999 Knicks Finals loss", question:"Which one hurt more?", sideA:"1994 Game 7 loss", caseA:"Game 7 of the 1994 NBA Finals. John Starks went 2-for-18 from the field. The Knicks were the better team. Hakeem Olajuwon was Hakeem Olajuwon. Patrick Ewing played his entire career chasing what was lost in that one game. A single performance by one player cost New York what should have been its championship. That is a specific and personal kind of pain.", sideB:"1999 Finals loss", caseB:"The 1999 Knicks were an eighth seed with no Ewing, playing on fumes, and still reached the Finals. They lost to the Spurs in five games, 78-77 in the clincher. Latrell Sprewell scored 35 in that game. It was the most they could have asked of themselves. The 1994 loss was heartbreaking. The 1999 loss was simply sad — watching a broken team fight until it couldn't.", teams:"Knicks" },
  { week:18, topic:"Dr. J's Nets vs Kidd's Nets", question:"Better Brooklyn/NJ basketball?", sideA:"Dr. J's ABA Nets", caseA:"Julius Erving's New York Nets won two ABA championships in 1974 and 1976. Dr. J was the most electrifying player alive — above the rim before above the rim existed as a phrase. The Nets' ABA title in 1976 came months before they sold his rights to fund the NBA merger. Two championships, the most exciting player in basketball, and then gone. The tragedy is part of the story.", sideB:"Jason Kidd's Nets", caseB:"The Kidd-led Nets reached back-to-back NBA Finals in 2002 and 2003, making them the only New Jersey/Brooklyn team to reach an NBA championship series. Kidd averaged a triple-double in the 2002 playoffs. The team featured Kenyon Martin, Richard Jefferson, and Kerry Kittles. They lost both Finals, but the ABA was a different league. Kidd's Nets competed at the highest level of basketball and were genuinely great.", teams:"Nets" },
  { week:19, topic:"1994 Rangers vs Islanders 1980-83 dynasty", question:"Greater NY hockey achievement?", sideA:"1994 Rangers", caseA:"The 1994 Rangers ended 54 years of waiting — the longest drought in NHL history. Messier's guarantee, the comeback against New Jersey, Matteau's double-overtime goal, Sam Rosen's call. They beat the Canucks in Game 7. No hockey moment in New York history has produced that specific combination of relief, disbelief, and joy.", sideB:"Islanders 1980-83 dynasty", caseB:"Four consecutive Stanley Cup championships. The first American franchise to accomplish it. Mike Bossy, Bryan Trottier, Denis Potvin, Billy Smith — a dynasty that matched the Montreal Canadiens. They swept the Edmonton Oilers in 1983 — a team that would go on to win five more Cups. Sustained excellence over four years is harder than one perfect playoff run.", teams:"Rangers/Islanders" },
  { week:20, topic:"Messier's guarantee vs Willis Reed limping out", question:"Greatest leadership moment in NY sports?", sideA:"Messier's guarantee", caseA:"Mark Messier told the newspapers — publicly, on the record — that the Rangers would win Game 6 against New Jersey. He then went out and scored a natural hat trick in the third period to make it happen. He bet his reputation, in the biggest market in the world, with the 54-year drought on the line. And he delivered.", sideB:"Willis Reed limping out", caseB:"Willis Reed said nothing. He simply walked out of the tunnel when nobody expected him to walk at all, hit the first two baskets, and let the building and the moment do the rest. Leadership doesn't always announce itself. Sometimes it just shows up. Reed's entrance required no words, no guarantee, no press conference. It required only the man himself.", teams:"Rangers/Knicks" },
  { week:21, topic:"Mike Bossy vs Bryan Trottier", question:"Greater Islander?", sideA:"Mike Bossy", caseA:"Mike Bossy scored 50 or more goals in each of his first nine NHL seasons — a record that has never been matched. He was passed over 14 times in the 1977 draft because scouts thought he wasn't physical enough. He scored 573 goals in 752 games and won four Stanley Cups. The goals-per-game ratio is the highest of any right wing in NHL history.", sideB:"Bryan Trottier", caseB:"Bryan Trottier was the engine of the Islanders dynasty — a two-way center who could dominate at both ends, win faceoffs, kill penalties, and still produce 50 goals and 100 points in a season. He won the Hart Trophy in 1979, the Conn Smythe in 1980, and four consecutive Cups. He was the most complete player on the most complete team of the era.", teams:"Islanders" },
  { week:22, topic:"Henrik Lundqvist vs Martin Brodeur", question:"Greater NY-area goalie?", sideA:"Henrik Lundqvist", caseA:"Henrik Lundqvist kept the Rangers relevant singlehandedly for a decade — carrying teams that, without him, would have missed the playoffs repeatedly. He won the Vezina Trophy in 2012 and is the franchise's all-time wins leader by a large margin. He is the reason the Rangers had seasons worth watching in the 2010s.", sideB:"Martin Brodeur", caseB:"Martin Brodeur won three Stanley Cups, holds the all-time NHL wins record, and built the Devils into a dynasty at the same time Lundqvist was learning to skate. His save percentage, his puck-handling, his longevity — 24 seasons in New Jersey — add up to the most decorated career any goalie in the metropolitan area has ever produced.", teams:"Rangers/Devils" },
  { week:23, topic:"Denis Potvin vs Brian Leetch", question:"Greatest NY-area defenseman ever?", sideA:"Denis Potvin", caseA:"Denis Potvin was the first overall pick in 1973 and won four Stanley Cups with the Islanders. He won three Norris Trophies, scored 310 career goals as a defenseman, and was the on-ice leader of the most successful dynasty in American hockey history. Bobby Orr changed the position. Denis Potvin proved it could be done without being Bobby Orr.", sideB:"Brian Leetch", caseB:"Brian Leetch won the Conn Smythe Trophy in 1994 — only the fifth defenseman in NHL history to win it — and was the most skilled offensive defenseman the Rangers have ever iced. He won two Norris Trophies, scored 1,028 career points, and was the best player on the ice during the run that ended 54 years of suffering. His skating was simply beautiful.", teams:"Islanders/Rangers" },
  { week:24, topic:"1940 Rangers Cup vs 1994 Rangers Cup", question:"Which one meant more to the franchise?", sideA:"1940 Stanley Cup", caseA:"The 1940 Stanley Cup was the Rangers' third championship in 14 years — the franchise at its peak, with the Blueshirts as one of the founding powers of the NHL. Bryan Hextall scored the overtime winner in Game 6. The franchise was in its prime. There was no drought yet, no 54 years of suffering, no chant. The 1940 Cup was simply a great team winning.", sideB:"1994 Stanley Cup", caseB:"The 1994 Stanley Cup ended 54 years of waiting. Every Rangers fan alive had been mocked with the 1940 chant. Messier's guarantee, the New Jersey series, Matteau's goal, Game 7 against Vancouver, Sam Rosen's call: the waiting is over. A championship that ends half a century of suffering means more than a championship that is simply the next one in a dynasty.", teams:"Rangers" },
  { week:25, topic:"Lou Lamoriello vs Bill Torrey", question:"Greater NY-area general manager?", sideA:"Lou Lamoriello", caseA:"Lou Lamoriello built three Stanley Cup championship teams in New Jersey across 23 years as Devils general manager — a 1.5-second pause while playing — and then went to Toronto and then the Islanders and continued winning. His teams played a structured defensive system, developed players through culture rather than contracts, and won at the highest level across four decades.", sideB:"Bill Torrey", caseB:"Bill Torrey built the Islanders dynasty from scratch — drafting Denis Potvin first overall in 1973, then Bryan Trottier in 1974, then Mike Bossy in 1977, then finding Billy Smith and Clark Gillies along the way. He assembled four consecutive Stanley Cup championships on Long Island through what may be the greatest decade of drafting in NHL history. Lamoriello won three. Torrey won four, consecutively.", teams:"Devils/Islanders" },
  { week:26, topic:"Namath's guarantee vs Eli's helmet catch", question:"Greatest NY football moment?", sideA:"Namath's guarantee", caseA:"Joe Namath guaranteed a Super Bowl victory three days before the game, when the Jets were 18-point underdogs against the Baltimore Colts. He then went out and won 16-7. The guarantee changed professional football by legitimizing the AFL, proving the two leagues were equal, and making the merger that created modern NFL possible. One statement reshaped an entire sport.", sideB:"Eli's helmet catch", caseB:"With 1:15 remaining in Super Bowl XLII, Eli Manning escaped a sack, launched a prayer, and David Tyree pinned it against his helmet for 32 yards. The Giants won 17-14. The 18-0 Patriots dynasty was stopped. It is the most improbable play in Super Bowl history — a moment so unlikely that no screenwriter would have gotten away with it.", teams:"Jets/Giants" },
  { week:27, topic:"Lawrence Taylor vs Michael Strahan", question:"Greatest NY defensive player ever?", sideA:"Lawrence Taylor", caseA:"Lawrence Taylor won the NFL MVP in 1986 — one of the only defensive players in history to do so. He recorded 132.5 career sacks, won two Super Bowls, and forced offensive coordinators to design entire game plans around the specific problem of stopping him. He didn't just redefine the linebacker position — he invented a new way of thinking about the defensive side of football.", sideB:"Michael Strahan", caseB:"Michael Strahan holds the NFL single-season sack record with 22.5, won two Super Bowls, and was the emotional leader of the Giants' 2007 championship team. His sack of Brady with 35 seconds left in the Super Bowl — releasing the pressure that had been building all game — is one of the most cathartic moments in Giants history. LT was greater. Strahan was beloved in a way LT's complicated legacy never quite allowed.", teams:"Giants" },
  { week:28, topic:"Phil Simms vs Eli Manning", question:"Greater Giants quarterback?", sideA:"Phil Simms", caseA:"Phil Simms completed 22 of 25 passes — an 88% completion rate — in Super Bowl XXI, a record that still stands as the greatest single-game performance by a quarterback in championship history. He played through injury, got booed on draft day, and built a career in New York that resulted in one of the most efficient and dominant Super Bowl performances anyone has ever produced.", sideB:"Eli Manning", caseB:"Eli Manning won two Super Bowls, was named MVP in both, and engineered two of the greatest comebacks in Super Bowl history. His helmet catch drive in 2008 stopped the 18-0 Patriots. His late drive in 2012 won another title. He was never the best quarterback in the league. He was the best quarterback in the two biggest games of his career, twice. That is its own kind of greatness.", teams:"Giants" },
  { week:29, topic:"1986 Giants vs 2007 Giants", question:"Better championship team?", sideA:"1986 Giants", caseA:"The 1986 Giants went 14-2 in the regular season, with Lawrence Taylor in the greatest defensive season of his career, and won Super Bowl XXI by 19 points. They were the best team in football by a considerable margin — dominant in a way the '07 team never was during the regular season. The '86 Giants didn't need a miracle. They were the miracle.", sideB:"2007 Giants", caseB:"The 2007 Giants were 10-6 in the regular season and no one's idea of a dynasty. They beat the 16-0 Patriots in the Super Bowl on David Tyree's helmet catch. The greatest upset in Super Bowl history. The '86 Giants were better. The '07 Giants did something more improbable. Dominance is impressive. Impossibility is memorable.", teams:"Giants" },
  { week:30, topic:"Joe Namath vs Chad Pennington", question:"Greatest Jets quarterback ever?", sideA:"Joe Namath", caseA:"Joe Namath guaranteed a Super Bowl and won one. He threw for over 4,000 yards in 1967, a number that seemed fictional at the time. He changed professional football by legitimizing an entire league. His career completion percentage and win total are modest by modern standards — because he played in an era where the forward pass was still a novelty. The guarantee alone earns him this title.", sideB:"Chad Pennington", caseB:"Chad Pennington holds the highest single-season completion percentage in NFL history and led the Jets to consecutive playoff seasons in 2002 and 2004. He came back from two torn rotator cuffs. He was accurate, smart, and utterly reliable. If you're making a case purely on quarterback play — not legend, not cultural impact, not guarantees — Pennington was the better passer.", teams:"Jets" },
  { week:31, topic:"Rex Ryan's 2010 Jets vs 1968-69 Jets", question:"Closest the Jets ever came?", sideA:"Rex Ryan's 2010 Jets", caseA:"The 2010 Jets beat the Patriots twice in the regular season, won two road playoff games, and reached the AFC Championship Game before losing to Pittsburgh. Rex Ryan was loud, confident, and occasionally right. The team had Mark Sanchez, a young receiver named Santonio Holmes, and a defense that was genuinely great. They came closer than any Jets team since 1969.", sideB:"1968-69 Jets", caseB:"The 1968-69 Jets won the Super Bowl. That ends the argument for most people. Joe Namath, the guarantee, 16-7 over Baltimore. The Jets have not been back to a Super Bowl since. The 2010 team was excellent. The 1969 team was champions. Excellence is not the same as winning.", teams:"Jets" },
  { week:32, topic:"Frank Gifford vs Odell Beckham Jr.", question:"Most electrifying Giants receiver ever?", sideA:"Frank Gifford", caseA:"Frank Gifford made eight Pro Bowls as a running back and receiver, won the NFL MVP in 1956, and defined what a New York athlete looked like for a generation — talented, elegant, and impossible to embarrass. He was the face of the Giants' golden era in the 1950s and 1960s and then became the face of Monday Night Football for 27 years. His legacy is spread across two eras.", sideB:"Odell Beckham Jr.", caseB:"Odell Beckham Jr. made the most famous catch in the history of the NFL on November 23, 2014 — a one-handed grab in the back of the end zone against Dallas that has been replayed more times than any other play in football history. His three seasons with the Giants were the most electrifying stretches of offensive football the franchise has produced in decades. He burned bright, briefly, and unforgettably.", teams:"Giants" },
  { week:33, topic:"Derek Jeter vs Patrick Ewing", question:"Greater NY athlete of the 1990s?", sideA:"Derek Jeter", caseA:"Derek Jeter won four World Series championships in the 1990s, was named World Series MVP in 2000, and became the most famous athlete in New York from the moment he arrived. The backhand flip, the Derek Jeter dive into the stands, the October walk-offs — the 1990s Jeter was the distillation of what it meant to win in New York.", sideB:"Patrick Ewing", caseB:"Patrick Ewing played 15 seasons carrying the Knicks on his back, made 11 All-Star teams, and brought the franchise to the NBA Finals in 1994 — the last Finals trip before 2026. He never won a ring. New York loved him anyway, completely and without condition. Jeter accumulated championships. Ewing accumulated something harder to define and in some ways harder to earn: unconditional loyalty from the hardest sports city on earth.", teams:"Yankees/Knicks" },
  { week:34, topic:"1950s Yankees vs 1990s Yankees", question:"Better dynasty?", sideA:"1950s Yankees", caseA:"The 1950s Yankees won five consecutive World Series from 1949 to 1953 and seven championships in a 10-year span. They had DiMaggio, then Mantle, with Berra behind the plate through all of it. Casey Stengel managed 10 pennants in 12 years. It is the most sustained run of dominance in the history of American professional sports.", sideB:"1990s Yankees", caseB:"The 1990s Yankees won four World Series in five years against modern, integrated competition in a 162-game season, in an era of free agency, revenue sharing, and competitive balance that makes sustained dominance far harder than it was in the 1950s. Rivera, Jeter, Posada, Pettitte — the Core Four. The case for the 1950s is the numbers. The case for the 1990s is the era.", teams:"Yankees" },
  { week:35, topic:"Madison Square Garden vs Yankee Stadium", question:"Greatest NY sports venue ever?", sideA:"Madison Square Garden", caseA:"The World's Most Famous Arena has hosted boxing's greatest fights, basketball's greatest games, hockey's greatest moments, and concerts that redefined what an arena show could be. The Garden is not just a sports venue — it is a cultural institution. Willis Reed walked out of a tunnel there. Messier's guarantee was delivered there. More has happened within those walls than in any other sports building on earth.", sideB:"Yankee Stadium", caseB:"Yankee Stadium — both the original and its successor — is the most storied address in American sports. Ruth, Gehrig, DiMaggio, Mantle, Jeter. Twenty-seven World Series championships played in the same spot in the Bronx. Lou Gehrig's farewell was delivered there. The House That Ruth Built is not just a building. It is the physical address of American baseball history.", teams:"Multiple" },
  { week:36, topic:"Marv Albert vs Bob Murphy", question:"Greatest NY sports broadcasting voice?", sideA:"Marv Albert", caseA:"Marv Albert created YES! defined basketball broadcasting for 50 years nationally, called five Michael Jordan championships, and was the voice of the Knicks and Rangers in New York for decades simultaneously. He grew up in Brooklyn as Marty Glickman's ballboy and became the most accomplished play-by-play broadcaster in NBA history. The national footprint of his career is unmatched.", sideB:"Bob Murphy", caseB:"Bob Murphy called Mets games for 42 years with a warmth and consistency that made him the most beloved broadcaster in franchise history. He was there for 1969 and 1986 and every loss in between. When he retired in 2003, the Mets gave him a ceremony usually reserved for players. Murphy didn't call games from a distance. He was part of the family, for 42 years, without ever making it about himself.", teams:"Multiple" },
  { week:37, topic:"Mike Francesa vs Marty Glickman", question:"Greater impact on NY sports media?", sideA:"Mike Francesa", caseA:"Mike Francesa created a format — the authoritative afternoon sports talk host — that every major American city copied. He hosted for 30 years, covered two Yankees dynasties, and built WFAN into the most profitable sports radio station in the country. The Pope of Sports Radio was not a nickname bestowed by admirers. It was earned, reluctantly, by everyone who disagreed with him.", sideB:"Marty Glickman", caseB:"Marty Glickman was the founding voice of New York sports broadcasting — calling Knicks games for 24 years, Giants games for 23, inventing the spatial language of football radio, and mentoring every great NY broadcaster who came after him. Marv Albert, Mike Breen, Howie Rose — all trace a direct line back to Glickman. Francesa built a format. Glickman built an entire generation.", teams:"Multiple" },
  { week:38, topic:"Best NY sports decade — 1950s vs 1990s vs 2020s", question:"Which decade was greatest for NY sports?", sideA:"1950s", caseA:"The 1950s gave New York five consecutive Yankees World Series titles, the NFL's greatest game (1958 Giants-Colts), a Giants football dynasty, the Brooklyn Dodgers winning their only World Series in 1955, and Willie Mays making The Catch in 1954. Three franchises at or near their peaks simultaneously. No other decade comes close in sheer volume of greatness.", sideB:"2020s", caseB:"The 2020s have produced the Knicks' first championship since 1973, the NY Liberty's WNBA dynasty, the Yankees remaining competitive, and a broader NY sports renaissance after years of mediocrity. The Rangers, Islanders, and Mets have all been relevant. And with Brunson, the Knicks look like they're just getting started. The 1950s had history. The 2020s may be making it.", teams:"Multiple" },
  { week:39, topic:"Ebbets Field vs old Shea vs old MSG", question:"Most missed NY sports venue?", sideA:"Ebbets Field", caseA:"Ebbets Field was the soul of Brooklyn — a neighborhood ballpark where the Dodgers played from 1913 to 1957, where Jackie Robinson broke the color barrier, where the borough's identity was formed around a baseball team. When the Dodgers left for Los Angeles, Ebbets Field was torn down and replaced with an apartment building. Brooklyn has not fully recovered in 65 years.", sideB:"Shea Stadium", caseB:"Shea Stadium was loud, windswept, and completely alive. The Beatles played there in 1965. Tom Seaver pitched there. Mookie Wilson's grounder went through Buckner's legs there. The 9/11 homer happened there. For a generation of Mets fans, Shea was not just a stadium — it was a specific relationship with a specific borough that Citi Field, however nice, has not replaced.", teams:"Multiple" },
  { week:40, topic:"Messier trade vs Piazza trade", question:"Best NY sports trade ever?", sideA:"Messier to the Rangers", caseA:"The Rangers acquired Mark Messier from Edmonton in October 1991 for Bernie Nicholls, Steven Rice, and Louie DeBrusk — and got a player who brought five Stanley Cup rings, a captain's presence, a championship guarantee, and the 1994 Cup. The return Edmonton received has been mostly forgotten. What New York received changed the franchise.", sideB:"Piazza to the Mets", caseB:"The Mets acquired Mike Piazza from the Marlins in May 1998 for Preston Wilson, Ed Yarnall, and Geoff Goetz — three players who combined for a handful of MLB seasons — and got the greatest offensive catcher in the history of the National League, the 9/11 home run, and eight seasons of the most dominant hitting the Mets have ever had.", teams:"Rangers/Mets" },
  { week:41, topic:"Mike Bossy vs Wayne Gretzky", question:"Greater pure goal scorer?", sideA:"Mike Bossy", caseA:"Mike Bossy's goals-per-game ratio of 0.762 is the highest of any right wing in NHL history. In his nine healthy seasons, he never scored fewer than 51 goals. He scored without the benefit of having Wayne Gretzky setting him up. He did it without the offensive infrastructure of the Oilers. He was simply the most efficient goal scorer who ever played the game.", sideB:"Wayne Gretzky", caseB:"Wayne Gretzky scored 92 goals in the 1981-82 season — a record that may never be broken. His career total of 894 goals is 94 more than the second-place finisher in NHL history. He holds or shares 61 NHL records. If you removed every goal he scored, he would still be the all-time points leader based on his assists alone. Bossy was extraordinary. Gretzky was singular.", teams:"Islanders/Oilers" },
  { week:42, topic:"Billy Smith vs Ken Dryden", question:"Greater NY-area playoff goalie?", sideA:"Billy Smith", caseA:"Billy Smith won four consecutive Stanley Cups with the Islanders and was the Conn Smythe Trophy winner in 1983 — the most crucial playoff goalie the franchise ever had. His willingness to slash opposing players who entered his crease was legendary and entirely intentional. In four championship runs, he was the last line of defense for the most successful American dynasty in NHL history.", sideB:"Ken Dryden", caseB:"Ken Dryden won six Stanley Cups in eight seasons with Montreal and had a career save percentage that, adjusted for era, is among the best in NHL history. He is the only player to win the Conn Smythe before winning the Calder Trophy as rookie of the year — he played so few regular season games that he was still technically a rookie after his first Cup. He retired at 31, at the peak of his career.", teams:"Islanders/Multiple" },
  { week:43, topic:"Islanders 1980 Cup vs 1983 Cup", question:"Which one meant more to the franchise?", sideA:"1980 Stanley Cup", caseA:"The 1980 Stanley Cup was the first — the one that proved the Islanders weren't just Long Island's team but a legitimate dynasty in the making. Bob Nystrom's overtime goal in Game 6 against the Flyers ended a decade of patience and building. The franchise had existed for only nine years. First ones are always the ones you carry with you.", sideB:"1983 Stanley Cup", caseB:"The 1983 Stanley Cup sweep of the Edmonton Oilers — who would go on to win five championships of their own — is the defining statement of the Islanders dynasty. They beat the future on their way to their fourth consecutive title. Gretzky, Messier, Coffey, Kurri — all swept in four games. The 1980 Cup announced the dynasty. The 1983 Cup cemented its place in history.", teams:"Islanders" },
  { week:44, topic:"Al Arbour vs Pat Riley", question:"Greater NY-area coach?", sideA:"Al Arbour", caseA:"Al Arbour coached the Islanders to four consecutive Stanley Cup championships — 19 seasons, 781 wins, and a franchise-building tenure that remains the standard for sustained excellence in NHL coaching. He didn't recruit superstars. He developed them, kept them together, and created a culture that produced the first American dynasty in hockey history.", sideB:"Pat Riley", caseB:"Pat Riley transformed the Knicks into a contender in the early 1990s with a defensive physicality that redefined how NBA basketball was played in New York. He then moved to Miami, built a rival, and won a championship there in 2006. The betrayal of leaving New York is part of the legacy — but so is the fact that everywhere Riley went, he won. Arbour built a dynasty on Long Island. Riley built two different contenders on two different coasts.", teams:"Islanders/Knicks" },
  { week:45, topic:"Brunson's pay cut vs Namath's guarantee", question:"Greatest single act of NY sports commitment?", sideA:"Brunson's pay cut", caseA:"In 2024, Jalen Brunson agreed to a contract extension worth $113 million less than he could have earned on the open market — specifically to free up cap room for the Knicks to build around him. He said nothing about it publicly. No press conference, no announcement, no attempt to make himself the story. He simply left $113 million on the table and went back to work.", sideB:"Namath's guarantee", caseB:"Joe Namath told the world, on the record, that the Jets would beat the Baltimore Colts in the Super Bowl — when New York was an 18-point underdog. Then he went out and won. The guarantee required something Brunson's pay cut didn't: public vulnerability. Brunson left money. Namath staked his reputation in the most public way possible, with the eyes of the entire country watching.", teams:"Knicks/Jets" },
  { week:46, topic:"Pete Alonso vs Darryl Strawberry", question:"Better Mets power hitter?", sideA:"Pete Alonso", caseA:"Pete Alonso holds the Mets' all-time home run record, set the MLB rookie home run record in 2019, and has been the most consistent power threat in the franchise for the past several years. His 2024 playoff home run against Milwaukee was one of the most celebrated moments in recent Mets history. Alonso is still playing. The career record is not yet written.", sideB:"Darryl Strawberry", caseB:"Darryl Strawberry made eight All-Star teams as a Met, hit 252 home runs in blue and orange, and was the cleanup hitter on the 1986 World Series champions. His combination of power and speed — 39 homers and 36 stolen bases in 1987 — was genuinely rare for a right fielder. The talent was transcendent. Alonso is more consistent. Strawberry, at his peak, was more spectacular.", teams:"Mets" },
  { week:47, topic:"Aaron Judge vs Mike Piazza", question:"Best pure hitter in NY baseball, last 30 years?", sideA:"Aaron Judge", caseA:"Aaron Judge hit 62 home runs in 2022, won three AL MVP awards, plays center field, and is the best position player in Yankees history since Mickey Mantle. His combination of power, plate discipline, and athleticism for a 6-foot-7 outfielder is genuinely unprecedented. He is still playing, still adding to the argument.", sideB:"Mike Piazza", caseB:"Mike Piazza batted .308 with 427 career home runs and was the greatest offensive catcher in the history of the National League. His numbers as a catcher — a position that carries defensive responsibilities that reduce offensive output — are the most impressive in the history of the position. Judge has more raw power. Piazza produced at an elite level while doing something far harder.", teams:"Yankees/Mets" },
  { week:48, topic:"KAT trade vs the Piazza trade", question:"Better NY team-building swing?", sideA:"Karl-Anthony Towns trade", caseA:"The Knicks traded Julius Randle, Donte DiVincenzo, and a first-round pick to Minnesota for Karl-Anthony Towns in October 2024 — a move that gave the team the stretch-five it had been missing for a decade. The fit was immediately obvious. Towns anchored the paint and spaced the floor, and the Knicks won the championship the following June. The trade worked exactly as designed.", sideB:"Piazza trade", caseB:"The Mets acquired Mike Piazza from Florida in May 1998 for three players who barely registered in the major leagues. They got eight seasons of the best offensive catching in NL history, a 9/11 home run that defined a city's grief and recovery, and a franchise player who transformed their competitive standing instantly. The cost was lower and the return was equally transformative.", teams:"Knicks/Mets" },
  { week:49, topic:"Citi Field vs Barclays Center", question:"Better modern NY sports venue?", sideA:"Citi Field", caseA:"Citi Field opened in 2009 and immediately set the standard for modern baseball parks in New York — good sightlines, reasonable concessions, the Jackie Robinson Rotunda, and dimensions that respect the game. It sits adjacent to the site of Shea Stadium, keeping the Mets rooted in Queens. It has hosted playoff baseball and some of the best moments in recent Mets history.", sideB:"Barclays Center", caseB:"Barclays Center gave Brooklyn a major sports venue for the first time since Ebbets Field. It hosts the Nets, the Islanders' occasional games, boxing, concerts, and events that have made it one of the most active arenas in the country. The building itself is striking — a rusted-steel exterior that fits the neighborhood. And it planted a sports flag in a borough that had been without one for 50 years.", teams:"Mets/Nets" },
  { week:50, topic:"NY Giants vs NY Jets", question:"Who really owns football in New York?", sideA:"New York Giants", caseA:"The Giants were founded in 1925 and have won four Super Bowls. They are the older franchise, the one New York grew up with, the team that hosted the Greatest Game Ever Played in 1958. They have more championships, more history, more rings, and more decades in which they were competitive. By the metrics of football, the Giants own New York.", sideB:"New York Jets", caseB:"The Jets won a Super Bowl by guaranteeing it when they were 18-point underdogs and then delivering. That is something the Giants, with all their Super Bowls, have never had to do. The Jets are also the city's underdog team, which in New York comes with its own devoted following. And they have something the Giants don't: a Super Bowl victory that changed professional football forever.", teams:"Giants/Jets" },
  { week:51, topic:"Best NY sports year — 1969, 1986, 1994, or 2026?", question:"Which single year was the greatest in NY sports history?", sideA:"1969", caseA:"In 1969, the Mets won the World Series as 100-to-1 longshots, the Jets were defending Super Bowl champions, the Knicks were building their championship roster, and the city was in the middle of a cultural transformation. The Miracle Mets alone would make 1969 the most memorable year in NY sports. Everything else is context.", sideB:"2026", caseB:"In 2026, the Knicks won their first championship since 1973 — ending 53 years of waiting — and the city experienced a sports renaissance after years of near-misses. The NY Liberty are defending WNBA champions from 2024. The 1969 miracle was more improbable. The 2026 Knicks championship was more overdue. If Brunson's run produces a dynasty, 2026 may look different in 20 years.", teams:"Multiple" },
  { week:52, topic:"Babe Ruth vs Joe DiMaggio vs Mickey Mantle vs Jalen Brunson", question:"Greatest NY athlete of all time?", sideA:"Babe Ruth", caseA:"Babe Ruth is the answer to this question and every version of this question. He changed baseball so completely that the sport before him and after him are essentially different games. He was the greatest pitcher in the American League before he became the greatest hitter in the history of the sport. No athlete in any American sport has had a greater impact on their game.", sideB:"The debate itself", caseB:"The fact that this debate exists at all — that Ruth, DiMaggio, Mantle, and now Brunson are all plausible answers — is the most New York thing about it. Other cities have one great athlete per generation. New York has produced so many that the argument is genuinely hard. Every generation gets to make the case for their player. That is what it means to be a New York sports fan.", teams:"Yankees/Knicks" },
];

// ── WEDNESDAY: DRAFT STORIES (monthly rotation — see getDayNugget) ──────────
const DRAFT_ENTRIES = [
...
function makeTeaser(body, maxWords) {
  ...
  // Split on paragraph breaks, take first paragraph
  const paras = body.split('\\n\\n');
  const firstPara = paras[0] || body;
  const words = firstPara.trim().split(/\\s+/);
  // Always truncate to maxWords regardless of paragraph length
  if (words.length <= maxWords) {
    // First paragraph is short — add a hint there's more
    return firstPara.trim() + (paras.length > 1 ? '...' : '');
  }
...
function getDayNugget(dayOfWeek, weekNumber) {
  ...
  switch(dayOfWeek) {
    ...
    case 3: {
    // Wednesday: NY Sports Debate (weekly) — picks by week number, cycles annually
    const debateWeek = ((weekNumber % 52) + 1);
    const debate = NY_DEBATES.find(d => d.week === debateWeek) || NY_DEBATES[weekNumber % NY_DEBATES.length];
    return { type:'debate', data: debate };
  }
    case 4: return { type:'glory_nugget', data: GLORY_MOMENTS[weekNumber % GLORY_MOMENTS.length] }; // Thursday: NY Glory Moment
...
function buildNuggetHtml(nugget, saturdayPoll, trophyEntry) {
  ...
  switch(nugget.type) {
    ...
    case 'glory_nugget': {
      const g = nugget.data;
      if (!g) return '';
      return wrap('&#127942; Thursday: NY Glory Moment', '#f0b429',
        '<div style="font-size:9px;font-weight:900;color:#c8201c;letter-spacing:0.2em;text-transform:uppercase;margin-bottom:4px">' + (g.team||'New York') + ' &nbsp;&middot;&nbsp; ' + g.year + '</div>'
        + '<div style="font-size:15px;font-weight:900;color:#111;font-family:Georgia,serif;line-height:1.35;margin-bottom:10px">' + (g.title||g.text) + '</div>'
        + '<div style="font-size:12px;color:#555;line-height:1.75;font-family:Georgia,serif">' + (g.story||g.text||'') + '</div>'
        + (g.link ? '<div style="margin-top:12px"><a href="' + g.link + '" style="color:#f0b429;font-size:11px;font-weight:700;text-decoration:none">&#128279; Go Deeper &rarr;</a></div>' : '')
      );
    }
    ...
    case 'debate': {
      const d = nugget.data;
      if (!d) return '';
      return wrap('&#9876;&#65039; Wednesday: NY Sports Debate', '#8b0000',
        '<div style="font-size:12px;color:#888;font-style:italic;margin-bottom:10px">' + d.question + '</div>'
        + '<table style="width:100%;border-collapse:collapse;margin-bottom:14px">'
        + '<tr>'
        + '<td style="width:50%;padding:10px;background:#f8f8f8;border:1px solid #ddd;border-right:2px solid #c8201c;vertical-align:top">'
        + '<div style="font-size:10px;font-weight:900;color:#c8201c;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:6px">&#127936; ' + d.sideA + '</div>'
        + '<div style="font-size:11px;color:#333;line-height:1.65;font-family:Georgia,serif">' + d.caseA + '</div>'
        + '</td>'
        + '<td style="width:50%;padding:10px;background:#f8f8f8;border:1px solid #ddd;vertical-align:top">'
        + '<div style="font-size:10px;font-weight:900;color:#1a5f1a;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:6px">&#127936; ' + d.sideB + '</div>'
        + '<div style="font-size:11px;color:#333;line-height:1.65;font-family:Georgia,serif">' + d.caseB + '</div>'
        + '</td>'
        + '</tr>'
        + '</table>'
        + '<div style="text-align:center;padding:10px;background:#1a1c1f;border-radius:4px">'
        + '<a href="' + SITE_URL + '/?tab=POLLS" style="color:#f0b429;font-size:11px;font-weight:900;'
        + 'letter-spacing:0.1em;text-transform:uppercase;text-decoration:none">&#128202; Cast Your Vote on NYSportsDaily.com &rarr;</a>'
        + '</div>'
      );
    }
...
const THIS_WEEK_IN_NY_SPORTS = [
  ...
  { week:21, date:"May 27, 1994", team:"Rangers", title:"Matteau! Matteau! Matteau!", story:"On May 27, 1994, Stephane Matteau scored in double overtime of Game 7 of the Eastern Conference Finals to send the New York Rangers to the Stanley Cup Final for the first time since 1979. Howie Rose's call — 'Matteau! Matteau! Matteau!' — was heard on radios across the five boroughs and on Long Island by people who had been waiting since 1940 for the Rangers to win a championship. Two weeks later, they would. But this moment — a journeyman winger scoring past Martin Brodeur in a Garden that was practically vibrating — was the moment the city allowed itself to believe for the first time.", link:"https://en.wikipedia.org/wiki/Stephane_Matteau" },
  ...
  { week:34, date:"August 15, 1965", team:"Mets", title:"The Beatles Play Shea Stadium", story:"On August 15, 1965, the Beatles played Shea Stadium in Flushing, Queens — the first stadium rock concert in history. 55,600 people packed a baseball park to watch four young men from Liverpool, and the music could barely be heard over the screaming. Lindsey Nelson, the Mets own broadcaster, called their arrival as if covering a ballgame, describing the crowd and the impossible scale of it. New York had figured out something the rest of the world had not yet: a baseball stadium could hold anything, including the biggest thing on earth." },
...
const GLORY_MOMENTS = [
  { year:1923, team:"Yankees", title:"The First Championship in The House That Ruth Built", story:"The 1923 Yankees won the first World Series ever played at Yankee Stadium, defeating the New York Giants in six games. Babe Ruth hit three home runs in the Series. The stadium that Ruth built delivered a championship in its very first season.", link:"https://en.wikipedia.org/wiki/1923_World_Series" },
  { year:1927, team:"Yankees", title:"Murderers\' Row Sweeps the World Series", story:"The 1927 Yankees are still considered by many the greatest team in baseball history. Babe Ruth hit 60 home runs that season — a record that stood for 34 years — and the team swept the Pittsburgh Pirates in the World Series. They won 110 games. Nobody else in the American League won more than 91.", link:"https://en.wikipedia.org/wiki/1927_New_York_Yankees_season" },
  { year:1928, team:"Yankees", title:"Back-to-Back: Ruth and Gehrig Take the Series Again", story:"The 1928 Yankees swept the Cardinals in four games to win back-to-back World Series titles. Babe Ruth batted .625 and Lou Gehrig batted .545 — the two greatest performances by a pair of teammates in Series history. New York was untouchable.", link:"https://en.wikipedia.org/wiki/1928_World_Series" },
  { year:1932, team:"Yankees", title:"The Called Shot", story:"In Game 3 of the 1932 World Series against the Chicago Cubs, Babe Ruth allegedly pointed to the center field bleachers before homering off Charlie Root. Whether he truly called it has been debated for 90 years. What is not debated: he hit the home run, exactly where he may or may not have pointed.", link:"https://en.wikipedia.org/wiki/Called_Shot" },
  { year:1936, team:"Yankees", title:"DiMaggio\'s First Championship", story:"Joe DiMaggio was a 21-year-old rookie when the Yankees won the 1936 World Series, the first of four consecutive championships. He batted .346 in the Series against the Giants. The dynasty that Ruth and Gehrig had built was now passing to the next generation.", link:"https://en.wikipedia.org/wiki/Joe_DiMaggio" },
  { year:1939, team:"Yankees", title:"Four Straight: The DiMaggio Dynasty Peaks", story:"The 1939 Yankees won their fourth consecutive World Series, sweeping the Cincinnati Reds in four games. Lou Gehrig had retired earlier that season with ALS. DiMaggio batted .381. It was the most dominant four-year run in baseball history.", link:"https://en.wikipedia.org/wiki/1939_New_York_Yankees_season" },
  { year:1941, team:"Yankees", title:"DiMaggio\'s 56 and Another Championship", story:"Joe DiMaggio hit safely in 56 consecutive games in 1941 — a record that has never been approached in the 85 years since. The Yankees won the World Series that October, defeating the Brooklyn Dodgers in five games. The summer of DiMaggio was the summer New York ruled baseball.", link:"https://en.wikipedia.org/wiki/Joe_DiMaggio%27s_56-game_hitting_streak" },
  { year:1947, team:"Yankees", title:"Jackie Robinson and the Last True Yankee-Dodger Classic", story:"The 1947 World Series between the Yankees and Brooklyn Dodgers was Jackie Robinson\'s first Fall Classic. Robinson had broken baseball\'s color barrier that April. The Yankees won in seven games, but the Series itself — played in New York, between New York\'s two teams — was the last of its kind. The Dodgers left for Los Angeles ten years later.", link:"https://en.wikipedia.org/wiki/Jackie_Robinson" },
  { year:1949, team:"Yankees", title:"The Dynasty Begins Again: Five in Five", story:"Casey Stengel took over as Yankees manager in 1949 and won the World Series in his very first season. It was the start of five consecutive championships — the most sustained run of dominance in the history of American professional sports. Stengel would win ten pennants in twelve years.", link:"https://en.wikipedia.org/wiki/1949_New_York_Yankees_season" },
  { year:1951, team:"Giants", title:"The Shot Heard \'Round the World", story:"On October 3, 1951, Bobby Thomson hit a three-run home run in the bottom of the ninth inning to send the New York Giants to the World Series. The Dodgers led 4-2 with one out. Russ Hodges\' call — \'The Giants win the pennant! The Giants win the pennant!\' — remains the most famous in baseball history.", link:"https://en.wikipedia.org/wiki/Shot_Heard_%27round_the_World_(baseball)" },
  { year:1952, team:"Yankees", title:"Mickey Mantle\'s First Championship", story:"Mickey Mantle was 20 years old when the Yankees won the 1952 World Series, defeating the Brooklyn Dodgers in seven games. It was the first of seven championships Mantle would win as a Yankee. The kid from Commerce, Oklahoma had arrived.", link:"https://en.wikipedia.org/wiki/Mickey_Mantle" },
  { year:1953, team:"Yankees", title:"Five Straight: The Greatest Dynasty in Sports", story:"The 1953 Yankees won their fifth consecutive World Series title, defeating the Dodgers in six games. No team in any major American sport has ever won five championships in a row. Casey Stengel managed all five. Mickey Mantle hit a 565-foot home run that April — the longest measured blast in baseball history.", link:"https://en.wikipedia.org/wiki/1953_New_York_Yankees_season" },
  { year:1955, team:"Brooklyn Dodgers", title:"\'Next Year\' Finally Arrives in Brooklyn", story:"In 1955, the Brooklyn Dodgers won the only World Series title in franchise history, defeating the New York Yankees in seven games. Sandy Amoros made a running catch in the sixth inning of Game 7 that saved the series. \'Wait till next year\' had been Brooklyn\'s motto for decades. It finally arrived, just two years before the Dodgers left for Los Angeles forever.", link:"https://en.wikipedia.org/wiki/1955_World_Series" },
  { year:1956, team:"Yankees", title:"Don Larsen\'s Perfect Game in the World Series", story:"On October 8, 1956, Don Larsen threw the only perfect game in World Series history — 27 batters, 27 outs, against the Brooklyn Dodgers at Yankee Stadium. Larsen was a journeyman pitcher who would finish his career with a losing record. He was perfect for exactly one afternoon, at exactly the right moment, in exactly the right place.", link:"https://en.wikipedia.org/wiki/Don_Larsen" },
  { year:1958, team:"Giants", title:"The Greatest Game Ever Played", story:"The 1958 NFL Championship between the New York Giants and Baltimore Colts is still called \'The Greatest Game Ever Played\' — the first sudden-death overtime in championship history, watched by 45 million Americans on television. The Colts won on Alan Ameche\'s one-yard run. The game convinced the NFL that it could challenge baseball as America\'s sport. New York hosted the moment that changed professional football forever.", link:"https://en.wikipedia.org/wiki/1958_NFL_Championship_Game" },
  { year:1961, team:"Yankees", title:"Maris Breaks Ruth\'s Record", story:"On October 1, 1961, Roger Maris hit his 61st home run of the season, breaking Babe Ruth\'s 34-year-old record. Commissioner Ford Frick had declared that Maris needed to break the record in 154 games (Ruth\'s schedule) or face an asterisk — Maris did it in game 162. He was booed in his own stadium much of the season. He hit the home run anyway.", link:"https://en.wikipedia.org/wiki/Roger_Maris" },
  { year:1962, team:"Yankees", title:"The Last Old-School World Series Title", story:"The 1962 World Series went seven games, with the Yankees defeating the San Francisco Giants — the same franchise they had beaten so many times when they were both in New York. Willie McCovey lined out to Bobby Richardson with two on and two out in the ninth inning of Game 7. It was the Yankees\' 20th World Series title, and the last they would win until 1977.", link:"https://en.wikipedia.org/wiki/1962_World_Series" },
  { year:1969, team:"Mets", title:"The Miracle Mets Win the World Series", story:"The 1969 Mets were 100-to-1 longshots in April and World Series champions in October. Tom Seaver, Jerry Koosman, and Cleon Jones led a team that beat the heavily favored Baltimore Orioles in five games. Fans stormed the field at Shea Stadium and tore up the turf. It remains the greatest upset in baseball history.", link:"https://en.wikipedia.org/wiki/1969_World_Series" },
  { year:1969, team:"Jets", title:"Broadway Joe\'s Guarantee", story:"Joe Namath guaranteed a Super Bowl victory three days before the game, when the Jets were 18-point underdogs against the Baltimore Colts. He then won 16-7. The guarantee changed professional football, legitimized the AFL, and forced the merger that created the modern NFL. Namath jogged off the field with his index finger raised, and New York had its moment.", link:"https://en.wikipedia.org/wiki/Super_Bowl_III" },
  { year:1970, team:"Knicks", title:"Willis Reed Limps Out of the Tunnel", story:"Before Game 7 of the 1970 NBA Finals, nobody knew if Willis Reed could walk. He had torn a muscle in his thigh five days earlier. When he came out of the tunnel at Madison Square Garden, the building erupted. He hit the first two baskets of the game — the only two points he would score all night — and the Knicks won their first championship. It is the most iconic moment in franchise history.", link:"https://en.wikipedia.org/wiki/1970_NBA_Finals" },
  { year:1970, team:"Knicks", title:"Clyde\'s Game 7", story:"Walt Frazier scored 36 points and handed out 19 assists in Game 7 of the 1970 NBA Finals while Willis Reed absorbed all the attention. It was the most complete performance in Knicks championship history. Frazier later said he was so locked in that game that he barely noticed the crowd noise. Clyde was the greatest Knick who ever played without being the most famous one that night.", link:"https://en.wikipedia.org/wiki/Walt_Frazier" },
  { year:1973, team:"Mets", title:"\'Ya Gotta Believe!\'", story:"The 1973 Mets were in last place in August. Tug McGraw rallied the clubhouse with \'Ya Gotta Believe!\' and the team won the division on the final day of the season with an 82-79 record. They beat the Big Red Machine in the NLCS and took the Oakland A\'s to seven games in the World Series before falling short. The phrase outlasted the season by decades.", link:"https://en.wikipedia.org/wiki/Tug_McGraw" },
  { year:1973, team:"Knicks", title:"The Knicks Win Their Second Championship", story:"The 1973 Knicks defeated the Los Angeles Lakers in five games for their second NBA title. Willis Reed won the Finals MVP. It was the closing chapter of the greatest era in franchise history — and the opening of a 53-year wait. Nobody in that building on that June night knew what was coming.", link:"https://en.wikipedia.org/wiki/1973_NBA_Finals" },
  { year:1977, team:"Yankees", title:"Reggie Hits Three in Game 6", story:"Reggie Jackson hit three home runs on three consecutive pitches from three different pitchers in Game 6 of the 1977 World Series. Each left the park on the first pitch thrown. \'Mr. October\' was born that night at Yankee Stadium, in front of 56,000 fans who hadn\'t expected to see something like this — and couldn\'t look away.", link:"https://en.wikipedia.org/wiki/1977_World_Series" },
  { year:1978, team:"Yankees", title:"Bucky Dent and the Boston Massacre", story:"The Yankees were 14 games behind the Red Sox in July 1978, then won 52 of their last 73 games to force a one-game playoff at Fenway. Bucky Dent — a light-hitting shortstop with four home runs all season — hit a three-run homer over the Green Monster in the seventh inning. Yankees 5, Red Sox 4. In Boston, his middle name became an expletive.", link:"https://en.wikipedia.org/wiki/Bucky_Dent" },
  { year:1980, team:"Islanders", title:"The Dynasty Begins: First Cup on Long Island", story:"The 1980 New York Islanders won their first Stanley Cup, defeating the Philadelphia Flyers in six games. Bob Nystrom scored the overtime winner in Game 6. It was the start of four consecutive championships — the first American franchise to accomplish the feat — built quietly on Long Island through drafting and development and the steadiness of Al Arbour behind the bench.", link:"https://en.wikipedia.org/wiki/1980_Stanley_Cup_Finals" },
  { year:1981, team:"Islanders", title:"Back-to-Back: The Dynasty Takes Hold", story:"The 1981 Islanders won their second consecutive Stanley Cup, defeating the Minnesota North Stars in five games. Mike Bossy, Bryan Trottier, and Denis Potvin were all in their prime. Jiggs McDonald called it with the specific joy of a broadcaster who understood what Long Island had been given. The dynasty was real and it was just getting started.", link:"https://en.wikipedia.org/wiki/1981_Stanley_Cup_Finals" },
  { year:1982, team:"Islanders", title:"Three in a Row", story:"The 1982 Islanders won their third consecutive Stanley Cup, defeating the Vancouver Canucks in four games. Mike Bossy scored 17 playoff goals. The Islanders were the most dominant team in hockey, and they were doing it on Long Island, in an arena that the rest of the hockey world had barely noticed until recently. Three straight. One more to go.", link:"https://en.wikipedia.org/wiki/1982_Stanley_Cup_Finals" },
  { year:1983, team:"Islanders", title:"Four Straight: Sweeping Gretzky\'s Oilers", story:"The 1983 Islanders swept the Edmonton Oilers — a team that included Gretzky, Messier, Coffey, and Kurri — to win their fourth consecutive Stanley Cup. It was the defining statement of the dynasty. The Oilers would go on to win five championships of their own. The Islanders beat them when it mattered most, in the Finals, in four straight games.", link:"https://en.wikipedia.org/wiki/1983_Stanley_Cup_Finals" },
  { year:1984, team:"Giants", title:"Lawrence Taylor Arrives", story:"By 1984, Lawrence Taylor had already redefined what an outside linebacker was supposed to do. He had won the NFL Defensive Player of the Year in each of his first three seasons. Offensive coordinators were designing entire game plans around the specific problem of not letting Taylor reach their quarterback. The Giants were building something. LT was the reason.", link:"https://en.wikipedia.org/wiki/Lawrence_Taylor" },
  { year:1986, team:"Mets", title:"Mookie Wilson\'s Grounder", story:"With two outs in the bottom of the tenth inning of Game 6, the Mets trailing the Red Sox, Mookie Wilson hit a slow roller to first base. It rolled through Bill Buckner\'s legs. Ray Knight scored the winning run. Two nights later the Mets won Game 7 and the World Series. No play in Mets history has been replayed more often, or felt more impossible.", link:"https://en.wikipedia.org/wiki/1986_World_Series" },
  { year:1986, team:"Giants", title:"Lawrence Taylor Wins the MVP", story:"Lawrence Taylor won the NFL MVP in 1986 — one of the very few defensive players in history to receive the award. He recorded 20.5 sacks and was the most feared presence in professional football. The Giants won Super Bowl XXI that season, 39-20 over Denver. It was, by any measure, the greatest season any defensive player has ever had.", link:"https://en.wikipedia.org/wiki/Lawrence_Taylor" },
  { year:1987, team:"Giants", title:"Super Bowl XXI: Phil Simms Is Perfect", story:"Phil Simms completed 22 of 25 passes in Super Bowl XXI — an 88% completion rate that stands as the best single-game performance by a quarterback in championship history. The Giants won 39-20 over the Denver Broncos. Simms had been booed on draft day in 1979. By February 1987, New York had no more doubts.", link:"https://en.wikipedia.org/wiki/Super_Bowl_XXI" },
  { year:1990, team:"Giants", title:"Norwood\'s Kick Goes Wide Right", story:"The Giants won Super Bowl XXV 20-19 over the Buffalo Bills when Scott Norwood\'s 47-yard field goal attempt sailed wide right as time expired. Ottis Anderson was named MVP at age 34. The Giants had held the ball for 40 minutes and 33 seconds — the most time of possession in Super Bowl history — to neutralize Jim Kelly and the Bills\' no-huddle offense. It is still the most strategically brilliant Super Bowl the franchise has ever played.", link:"https://en.wikipedia.org/wiki/Super_Bowl_XXV" },
  { year:1994, team:"Rangers", title:"The Guarantee and the Natural Hat Trick", story:"Down 3-2 to the New Jersey Devils in the Eastern Conference Finals, Mark Messier guaranteed a Rangers victory in Game 6. He then scored a natural hat trick in the third period to make it happen. Two nights later, Stephane Matteau scored in double overtime of Game 7. Two weeks after that, the Rangers were Stanley Cup champions for the first time since 1940.", link:"https://en.wikipedia.org/wiki/Mark_Messier" },
  { year:1994, team:"Rangers", title:"Matteau! Matteau! Matteau!", story:"Stephane Matteau scored in double overtime of Game 7 of the Eastern Conference Finals to send the Rangers to the Stanley Cup Final. Howie Rose\'s call — \'Matteau! Matteau! Matteau! And the Rangers have one more step to take!\' — is the most famous in New York hockey history. The Garden shook. Fifty-four years of waiting had one more month to go.", link:"https://en.wikipedia.org/wiki/Stephane_Matteau" },
  { year:1994, team:"Rangers", title:"The Wait Is Over: 54 Years End", story:"On June 14, 1994, the New York Rangers defeated the Vancouver Canucks in Game 7 to win the Stanley Cup for the first time since 1940. Sam Rosen\'s call — \'The waiting is over — the New York Rangers are the Stanley Cup champions!\' — was heard in homes across the tri-state area. Mark Messier hoisted the Cup first. The Garden had never been louder.", link:"https://en.wikipedia.org/wiki/1994_Stanley_Cup_Finals" },
  { year:1996, team:"Yankees", title:"The Dynasty Restarts in the Bronx", story:"The 1996 Yankees won the World Series for the first time since 1978, defeating the Atlanta Braves in six games after falling behind two games to none. Derek Jeter was 22 years old. Mariano Rivera pitched in relief. Bernie Williams hit .417 in the Series. The dynasty that would produce four championships in five years had begun.", link:"https://en.wikipedia.org/wiki/1996_World_Series" },
  { year:1998, team:"Yankees", title:"The Greatest Season: 125 Wins", story:"The 1998 Yankees won 114 regular season games and 125 total including the postseason — sweeping three consecutive opponents in the playoffs. David Wells threw a perfect game in May. David Cone threw one in July. They swept the Padres in the World Series. It is, by any objective measure, the greatest single season in the history of the franchise.", link:"https://en.wikipedia.org/wiki/1998_New_York_Yankees_season" },
  { year:1999, team:"Yankees", title:"Back-to-Back-to-Back", story:"The 1999 Yankees won their third consecutive World Series title, sweeping the Atlanta Braves in four games. Mariano Rivera was named Series MVP. Roger Clemens had joined the team. Derek Jeter was 25 years old and already had three rings. The dynasty that nobody had seen coming in 1996 was now the most dominant force in baseball.", link:"https://en.wikipedia.org/wiki/1999_World_Series" },
  { year:1999, team:"Knicks", title:"The Eighth Seed Reaches the Finals", story:"The 1999 New York Knicks were the eighth and final seed in the Eastern Conference playoffs — and became the only eighth seed in NBA history to reach the Finals. Patrick Ewing tore his Achilles along the way. The gutted team lost to the Spurs in five games. It was the Knicks\' last Finals trip for 27 years. Latrell Sprewell scored 35 points in the losing Game 5 effort.", link:"https://en.wikipedia.org/wiki/1999_NBA_Finals" },
  { year:2000, team:"Yankees", title:"Four in Five: The Dynasty Complete", story:"The 2000 Yankees won their fourth World Series in five years, defeating the New York Mets — their crosstown rivals — in five games in the only Subway Series since 1956. It was the most complete dynasty the Yankees had built since the 1950s. Roger Clemens threw a broken bat at Mike Piazza in Game 2. The Yankees won anyway. They usually did.", link:"https://en.wikipedia.org/wiki/2000_World_Series" },
  { year:2001, team:"Mets", title:"Piazza\'s Home Run, Ten Days After", story:"On September 21, 2001, ten days after the terrorist attacks, Mike Piazza hit a two-run home run in the eighth inning at Shea Stadium. The Mets were trailing 2-1 against the Braves. The stadium erupted in a way that was about far more than baseball. The Mets won 3-2. For one night, New York was given something to stand up for.", link:"https://en.wikipedia.org/wiki/Mike_Piazza" },
  { year:2004, team:"Yankees", title:"The Night the 3-0 Lead Disappeared", story:"The Yankees led the Boston Red Sox 3-0 in the 2004 ALCS — a lead no team in baseball history had ever lost. Dave Roberts stole second base in the ninth inning of Game 4. David Ortiz hit a walkoff home run. Then another. Then Curt Schilling pitched through a bloody sock. The Red Sox won four straight games and broke a curse. New York never saw it coming.", link:"https://en.wikipedia.org/wiki/2004_American_League_Championship_Series" },
  { year:2007, team:"Giants", title:"The Helmet Catch Stops the Perfect Season", story:"With 1:15 remaining in Super Bowl XLII, Eli Manning escaped a sack, heaved a ball downfield, and David Tyree pinned it against his helmet for 32 yards. The Giants won 17-14. The New England Patriots did not complete the first 19-0 season in NFL history. It is the most improbable play in Super Bowl history, made by a receiver who never caught another meaningful pass in the NFL.", link:"https://en.wikipedia.org/wiki/Super_Bowl_XLII" },
  { year:2008, team:"Giants", title:"Eli Manning: Two-Time Super Bowl Champion", story:"Eli Manning won his second Super Bowl MVP in five years in Super Bowl XLVI, defeating the Patriots again 21-17. The Giants had won two Super Bowls in five years, both against the same dynasty, both as underdogs. Manning engineered both comeback victories. New York had doubted him when he arrived. By 2012, there was nothing left to doubt.", link:"https://en.wikipedia.org/wiki/Super_Bowl_XLVI" },
  { year:2015, team:"Mets", title:"The Mets Return to the World Series", story:"The 2015 New York Mets reached the World Series for the first time since 2000, defeating the Chicago Cubs in four games in the NLCS. Jacob deGrom, Noah Syndergaard, Matt Harvey, and Steven Matz formed a rotation that was, for one October, as dominant as any in Mets history. They lost the World Series to the Royals in five games. The rotation\'s promise never fully delivered. But that October was real.", link:"https://en.wikipedia.org/wiki/2015_World_Series" },
  { year:2022, team:"Yankees", title:"Aaron Judge Hits 62", story:"On October 4, 2022, Aaron Judge hit his 62nd home run of the season, breaking Roger Maris\'s American League record of 61 that had stood since 1961. Judge had spent the entire summer declining to sign a contract extension, betting on himself. He was right to. He won the AL MVP unanimously. The number 62 is now his, cleanly and without asterisk.", link:"https://en.wikipedia.org/wiki/Aaron_Judge" },
  { year:2024, team:"Liberty", title:"Breanna Stewart and the Liberty Win the WNBA Title", story:"The New York Liberty won their first WNBA championship in 2024, defeating the Minnesota Lynx in five games. Breanna Stewart, Sabrina Ionescu, and Jonquel Jones had assembled one of the most talented rosters in league history. The Garden sold out every home game. New York finally had its WNBA champion, and the city had embraced women\'s basketball in a way that felt genuinely different from anything before.", link:"https://en.wikipedia.org/wiki/2024_WNBA_Finals" },
  { year:2024, team:"Mets", title:"Pete Alonso\'s Playoff Home Run", story:"Pete Alonso hit a home run in the eighth inning of Game 3 of the 2024 Wild Card series against the Milwaukee Brewers, breaking a 1-1 tie and sending the Mets to the NLDS for the first time in years. The call by Howie Rose — \'It\'s gone! He did it! Pete Alonso with the most memorable home run of his career!\' — was played on the team\'s flight home. The Mets were back.", link:"https://en.wikipedia.org/wiki/Pete_Alonso" },
  { year:2026, team:"Knicks", title:"Jalen Brunson Ends 53 Years of Waiting", story:"On June 13, 2026, Jalen Brunson scored 45 points in San Antonio — 13 of them in an uninterrupted fourth-quarter stretch — to clinch the NBA championship for the New York Knicks, their first since 1973. The Finals MVP vote was unanimous. Brunson had taken $113 million less than market value to help build the team. He then won the championship. The waiting, finally, was over.", link:"https://en.wikipedia.org/wiki/Jalen_Brunson" },
  { year:2026, team:"Knicks", title:"The Largest Comeback in Finals History", story:"Game 4 of the 2026 NBA Finals. The Knicks trailed by 29 points at halftime. Victor Wembanyama had tied a Finals record with five blocks in the first half alone. New York won the game 107-106 — the largest comeback in NBA Finals history — on a tip-in by OG Anunoby with 1.2 seconds remaining. It set up the title-clinching win two nights later in San Antonio.", link:"https://en.wikipedia.org/wiki/2026_NBA_Finals" },
];

// ── Trivia questions ──────────────────────────────────────────────────────────
const TRIVIA_QUESTIONS = [
  // difficulty: 1=easy (Mon/Tue), 2=medium (Wed/Thu), 3=hard (Fri/Sat/Sun)
  { q:'How many World Series championships have the Yankees won in total?', hint:'More than any other team in baseball history.', a:'27', difficulty:1, team:'Yankees', link:'https://en.wikipedia.org/wiki/New_York_Yankees' },
  { q:'Joe Namath guaranteed victory before which Super Bowl?', hint:'The Jets were 18-point underdogs against the Baltimore Colts.', a:'Super Bowl III (January 1969)', difficulty:1, team:'Jets', link:'https://en.wikipedia.org/wiki/Super_Bowl_III' },
  { q:'Which Knick limped onto the MSG court before Game 7 of the 1970 NBA Finals?', hint:'His entrance may be the most dramatic moment in Knicks history.', a:'Willis Reed', difficulty:1, team:'Knicks', link:'https://en.wikipedia.org/wiki/Willis_Reed' },
  { q:'Which Islander scored 50+ goals in 9 consecutive seasons and won 4 straight Cups?', hint:'He wore #22 and is considered one of the greatest goal-scorers ever.', a:'Mike Bossy', difficulty:1, team:'Islanders', link:'https://en.wikipedia.org/wiki/Mike_Bossy' },
  { q:'In what year did the Mets win the World Series as 100-to-1 longshots?', hint:'They were known as \"The Miracle Mets.\"', a:'1969', difficulty:1, team:'Mets', link:'https://en.wikipedia.org/wiki/1969_New_York_Mets_season' },
  { q:'Which Giants linebacker won the NFL MVP award in 1986?', hint:'Widely considered the greatest defensive player in NFL history.', a:'Lawrence Taylor', difficulty:1, team:'Giants', link:'https://en.wikipedia.org/wiki/Lawrence_Taylor' },
  { q:'Who scored the overtime winner to give the Islanders their first Stanley Cup in 1980?', hint:'He spent his entire 14-year career on Long Island.', a:'Bob Nystrom', difficulty:1, team:'Islanders', link:'https://en.wikipedia.org/wiki/Bob_Nystrom' },
  { q:'Which Yankee holds the all-time MLB saves record with 652 career saves?', hint:'He was the first unanimous Hall of Fame inductee in baseball history.', a:'Mariano Rivera', difficulty:1, team:'Yankees', link:'https://en.wikipedia.org/wiki/Mariano_Rivera' },
  { q:'Babe Ruth hit 714 career home runs. How many of those came as a New York Yankee?', hint:'Ruth hit 659 home runs in pinstripes — not all of them.', a:'659', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Babe_Ruth' },
  { q:'Joe DiMaggio\'s 56-game hitting streak is famous. What is the second-longest hitting streak in Yankees history?', hint:'Don Mattingly hit in 24 consecutive games in 1987 — the second-longest streak in Yankees history.', a:'Don Mattingly hit in 24 consecutive games in 1987', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Don_Mattingly' },
  { q:'Which Yankees pitcher threw a perfect game in the 1956 World Series — the only perfect game in Fall Classic history?', hint:'Don Larsen threw the only perfect game in World Series history on October 8, 1956, against the Brooklyn Dodgers.', a:'Don Larsen threw the only perfect game in World Se', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Don_Larsen' },
  { q:'Ron Guidry went 25-3 in 1978. What was his ERA that historic season?', hint:'Guidry posted a 1.', a:'1.74', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Ron_Guidry' },
  { q:'Brian Doyle was an unlikely hero in the 1978 World Series. What did he bat in that Series, filling in for the injured Willie Randolph?', hint:'Brian Doyle batted .', a:'.438', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Brian_Doyle_(baseball)' },
  { q:'The Yankees bought Babe Ruth from the Red Sox in 1919. What was the purchase price?', hint:'Red Sox owner Harry Frazee sold Ruth to the Yankees for $100,000 — plus an $35,000 loan against Fenway Park.', a:'$100,000', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Curse_of_the_Bambino' },
  { q:'Which Yankee pitcher threw a perfect game on July 4, 1983 — and who were they pitching against?', hint:'Dave Righetti no-hit the Boston Red Sox on the Fourth of July, 1983, at Yankee Stadium.', a:'A', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Dave_Righetti' },
  { q:'Derek Jeter retired with 3,465 career hits. How many World Series championships did he win with the Yankees?', hint:'Jeter won 5 World Series championships with the Yankees — 1996, 1998, 1999, 2000, and 2009.', a:'5', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Derek_Jeter' },
  { q:'Mariano Rivera is the all-time saves leader. What is his career save total?', hint:'Rivera finished his career with 652 saves — 95 more than the next closest pitcher (Trevor Hoffman, 601).', a:'652', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Mariano_Rivera' },
  { q:'Don Mattingly set a major league record in 1987 by hitting a home run in how many consecutive games?', hint:'Mattingly tied Dale Long\'s major league record (later tied by Ken Griffey Jr.', a:'8', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Don_Mattingly' },
  { q:'Who holds the record for the longest hitting streak in Mets history?', hint:'Moises Alou hit in 30 consecutive games for the Mets in 2007 — at age 41, the longest hitting streak', a:'Moises Alou hit in 30 consecutive games for the Me', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Moises_Alou' },
  { q:'Tom Seaver won 3 Cy Young Awards as a Met. What was his nickname?', hint:'Tom Seaver was known both as \"Tom Terrific\" and \"The Franchise\" — the latter because he was so centr', a:'Tom Seaver was known both as \"Tom Terrific\" and \"T', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Tom_Seaver' },
  { q:'In the 1973 NLCS, the Mets beat the heavily favored Cincinnati Reds. What was New York\'s regular season record that year?', hint:'The 1973 Mets won the NL pennant with an 82-79 record — one of the worst records by any pennant winn', a:'82-79', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/1973_New_York_Mets_season' },
  { q:'How many games did the Mets win in their 1986 championship season?', hint:'The 1986 Mets won 108 regular season games — the most in franchise history.', a:'108', difficulty:3, team:'Mets', link:'https://en.wikipedia.org/wiki/1986_New_York_Mets_season' },
  { q:'Which player\'s grounder went through Bill Buckner\'s legs in Game 6 of the 1986 World Series?', hint:'Mookie Wilson\'s slow roller trickled through first baseman Bill Buckner\'s legs in the 10th inning of', a:'Mookie Wilson', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/1986_World_Series' },
  { q:'Jacob deGrom won back-to-back Cy Young Awards in 2018 and 2019. What was his ERA in 2018?', hint:'deGrom posted a 1.', a:'1.70', difficulty:3, team:'Mets', link:'https://en.wikipedia.org/wiki/Jacob_deGrom' },
  { q:'Mike Piazza\'s home run on September 21, 2001 came in what inning, against which team?', hint:'Piazza hit his famous two-run homer in the 8th inning against the Atlanta Braves, 10 days after the ', a:'Piazza hit his famous two-run homer in the 8th inn', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Mike_Piazza' },
  { q:'Who holds the all-time Mets record for career home runs?', hint:'Pete Alonso passed Darryl Strawberry\'s franchise record of 252 home runs and continues to add to the total.', a:'D', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Pete_Alonso' },
  { q:'The Mets\' original 1962 roster was famously bad. What was their win total that season?', hint:'The 1962 Mets went 40-120 — the worst record in modern baseball history.', a:'40', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/1962_New_York_Mets_season' },
  { q:'Felix Millan was a beloved Mets second baseman in the early 1970s known for his unique batting style. What was it?', hint:'Felix Millan was famous for choking up on the bat almost to the knob — one of the most extreme choki', a:'Felix Millan was famous for choking up on the bat ', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Felix_Mill%C3%A1n' },
  { q:'The Islanders won 4 consecutive Stanley Cups from 1980-1983. Who was their general manager who built the dynasty through the draft?', hint:'Bill Torrey built the dynasty by drafting Denis Potvin 1st overall in 1973, Bryan Trottier 22nd in 1', a:'Bill Torrey built the dynasty by drafting Denis Po', difficulty:2, team:'Islanders', link:'https://en.wikipedia.org/wiki/Bill_Torrey' },
  { q:'How many teams passed on Mike Bossy in the 1977 NHL Draft before the Islanders selected him 15th overall?', hint:'14 teams passed on Bossy, concerned he wasn\'t physical enough.', a:'14', difficulty:3, team:'Islanders', link:'https://en.wikipedia.org/wiki/Mike_Bossy' },
  { q:'Pat LaFontaine scored the famous overtime winner in the \"Easter Epic\" against Washington in 1987. How many overtime periods did that Game 7 last?', hint:'The Easter Epic — Game 7 of the 1987 Patrick Division Semifinals — went four overtime periods before', a:'4 OT', difficulty:3, team:'Islanders', link:'https://en.wikipedia.org/wiki/Easter_Epic' },
  { q:'Denis Potvin was drafted first overall by the Islanders in what year?', hint:'Denis Potvin was selected first overall in the 1973 NHL Draft.', a:'1973', difficulty:2, team:'Islanders', link:'https://en.wikipedia.org/wiki/Denis_Potvin' },
  { q:'Jiggs McDonald called Islanders games for 15 years. Which prestigious Hall of Fame inducted him for his broadcasting career?', hint:'Jiggs McDonald was inducted into the Hockey Hall of Fame in the builders category for his broadcasti', a:'Hockey Hall of Fame', difficulty:2, team:'Islanders', link:'https://en.wikipedia.org/wiki/Jiggs_McDonald' },
  { q:'Mark Messier guaranteed a win in Game 6 of the 1994 Eastern Conference Finals against New Jersey. What did he do that night?', hint:'Messier scored a natural hat trick — three consecutive goals — in the third period to give the Rangers a 4-2 win.', a:'Scored a natural hat trick', difficulty:2, team:'Rangers', link:'https://en.wikipedia.org/wiki/Mark_Messier' },
  { q:'The Rangers won the 1994 Stanley Cup, ending a drought that began in what year?', hint:'The Rangers last won the Cup in 1940, a drought of 54 years.', a:'1940', difficulty:2, team:'Rangers', link:'https://en.wikipedia.org/wiki/1994_Stanley_Cup_Finals' },
  { q:'Howie Rose\'s famous call of Stephane Matteau\'s overtime goal in 1994 repeated the player\'s name how many times?', hint:'Rose called \"Matteau! Matteau! Matteau!\" — three times — before completing the call.', a:'3', difficulty:3, team:'Rangers', link:'https://en.wikipedia.org/wiki/Stephane_Matteau' },
  { q:'Walt Frazier scored 36 points in Game 7 of the 1970 NBA Finals. How many assists did he add?', hint:'Frazier had 36 points AND 19 assists in Game 7 while Willis Reed absorbed all the attention.', a:'19', difficulty:3, team:'Knicks', link:'https://en.wikipedia.org/wiki/1970_NBA_Finals' },
  { q:'How many All-Star Game appearances did Patrick Ewing make as a Knick?', hint:'Ewing made 11 All-Star teams as a Knick — an extraordinary career that included the 1985 Rookie of t', a:'11', difficulty:3, team:'Knicks', link:'https://en.wikipedia.org/wiki/Patrick_Ewing' },
  { q:'Jalen Brunson took a pay cut to help the Knicks build their roster. Approximately how much less than market value did he accept?', hint:'Brunson accepted approximately $113 million less than he could have earned on the open market when h', a:'$113 million', difficulty:2, team:'Knicks', link:'https://en.wikipedia.org/wiki/Jalen_Brunson' },
  { q:'The Knicks went 53 years between championships. Their last title before 2026 came in what year and against which team?', hint:'The Knicks defeated the Los Angeles Lakers in five games in 1973, with Willis Reed winning the Finals MVP.', a:'The Knicks defeated the Los Angeles Lakers in five', difficulty:2, team:'Knicks', link:'https://en.wikipedia.org/wiki/1973_NBA_Finals' },
  { q:'Phil Simms set a Super Bowl record in Super Bowl XXI with his completion percentage. What was it?', hint:'Simms completed 22 of 25 passes (88%) in Super Bowl XXI against the Denver Broncos — still the highe', a:'88.0%', difficulty:3, team:'Giants', link:'https://en.wikipedia.org/wiki/Super_Bowl_XXI' },
  { q:'Lawrence Taylor won the NFL MVP in 1986 — one of very few defensive players to do so. How many sacks did he record that season?', hint:'Taylor recorded 20.', a:'20.5', difficulty:3, team:'Giants', link:'https://en.wikipedia.org/wiki/Lawrence_Taylor' },
  { q:'David Tyree\'s helmet catch in Super Bowl XLII covered how many yards?', hint:'Tyree pinned the ball against his helmet for 32 yards with 1:15 remaining, setting up the Giants\' wi', a:'32 yards', difficulty:3, team:'Giants', link:'https://en.wikipedia.org/wiki/Super_Bowl_XLII' },
  { q:'What were the Jets\' exact odds as underdogs before Super Bowl III?', hint:'The Jets were 18-point underdogs to the Baltimore Colts when Namath made his guarantee.', a:'18-point underdogs', difficulty:2, team:'Jets', link:'https://en.wikipedia.org/wiki/Super_Bowl_III' },
  { q:'Joe Namath threw for over 4,000 yards in 1967 — a staggering total for that era. Who was his primary wide receiver?', hint:'Don Maynard was Namath\'s primary deep threat and one of the most underrated wide receivers in AFL/NFL history.', a:'Don Maynard was Namath\'s primary deep threat and o', difficulty:2, team:'Jets', link:'https://en.wikipedia.org/wiki/Don_Maynard' },
  { q:'Martin Brodeur holds the NHL record for career wins. What is that total?', hint:'Brodeur finished his career with 691 wins — 82 more than the second-place finisher.', a:'691', difficulty:3, team:'Devils', link:'https://en.wikipedia.org/wiki/Martin_Brodeur' },
  { q:'The Devils won their first Stanley Cup in 1995. Who did they sweep in the Finals?', hint:'The Devils swept the Detroit Red Wings in four games in the 1995 Finals — a stunning result given De', a:'The Devils swept the Detroit Red Wings in four gam', difficulty:2, team:'Devils', link:'https://en.wikipedia.org/wiki/1995_Stanley_Cup_Finals' },
  { q:'Julius Erving (Dr. J) played for the New York Nets and won two ABA championships. Which year did the Nets win their first?', hint:'Dr.', a:'1974', difficulty:2, team:'Nets', link:'https://en.wikipedia.org/wiki/Julius_Erving' },
  { q:'The New York Cosmos drew the largest soccer crowd in North American history when Pelé played. What was that attendance figure at Giants Stadium?', hint:'The Cosmos drew 77,691 fans to Giants Stadium in 1977 — the largest soccer crowd in North American history at the time.', a:'77,691', difficulty:2, team:'Cosmos', link:'https://en.wikipedia.org/wiki/New_York_Cosmos' },
  { q:'Marty Glickman was pulled from the 1936 Berlin Olympics relay team under pressure to avoid offending Adolf Hitler. What event was he supposed to compete in?', hint:'Glickman and Sam Stoller were removed from the 4x100 relay team in Berlin — the only Jewish athletes on the US squad.', a:'4x100 relay', difficulty:2, team:'Multiple', link:'https://en.wikipedia.org/wiki/Marty_Glickman' },
  { q:'Bob Murphy called Mets games for how many seasons?', hint:'Murphy called Mets games from the franchise\'s very first season in 1962 until his retirement after 2', a:'42', difficulty:3, team:'Mets', link:'https://en.wikipedia.org/wiki/Bob_Murphy_(sportscaster)' },
  { q:'Mike Breen, longtime voice of the Knicks and NBA on ABC/ESPN, grew up rooting for the Knicks. Approximately how old was he when he first became a fan?', hint:'Breen grew up in Yonkers and started rooting for the Knicks around age 7 — old enough to remember bo', a:'7 years old', difficulty:2, team:'Knicks', link:'https://en.wikipedia.org/wiki/Mike_Breen' },
  { q:'The US Open was held at Shinnecock Hills on Long Island in 1995. Who won that championship?', hint:'Corey Pavin won the 1995 US Open at Shinnecock Hills with a memorable fairway wood approach on the 18th hole.', a:'C', difficulty:2, team:'Golf', link:'https://en.wikipedia.org/wiki/1995_U.S._Open_(golf)' },
  { q:'Wyndham Clark won the 2026 US Open at Shinnecock Hills. What was his winning score?', hint:'Wyndham Clark finished at 4-under par to win the 2026 US Open at Shinnecock Hills by one stroke over', a:'4-under', difficulty:2, team:'Golf', link:'https://en.wikipedia.org/wiki/2026_U.S._Open_(golf)' },
  { q:'The OJ Simpson car chase interrupted Game 5 of the 1994 NBA Finals. Which teams were playing?', hint:'NBC split-screened the Knicks-Rockets Game 5 with the Bronco chase — the same night the Rangers held', a:'Knicks vs. Houston Rockets', difficulty:2, team:'Knicks', link:'https://en.wikipedia.org/wiki/O._J._Simpson_murder_case' },
  { q:'The 1958 NFL Championship between the Giants and Colts is called \"The Greatest Game Ever Played.\" What historic first did it feature?', hint:'The Colts defeated the Giants 23-17 in the first sudden-death overtime in NFL championship history.', a:'First sudden-death overtime in championship history', difficulty:2, team:'Giants', link:'https://en.wikipedia.org/wiki/1958_NFL_Championship_Game' },
  { q:'The Islanders\' dynasty and the Yankees\' dynasty both peaked in the early 1980s. How many total championships did New York teams win between 1977 and 1983?', hint:'The Yankees won in 1977 and 1978 (2 championships), and the Islanders won in 1980, 1981, 1982, and 1', a:'6', difficulty:3, team:'Multiple', link:'https://en.wikipedia.org/wiki/New_York_Islanders' },
  { q:'Which NY sports announcer invented the word \"swish\" to describe a basketball going cleanly through the net?', hint:'Marty Glickman coined \"swish\" during his 24 years calling Knicks games — one of several broadcast in', a:'Marty Glickman', difficulty:2, team:'Knicks', link:'https://en.wikipedia.org/wiki/Marty_Glickman' },
  { q:'Roger Maris broke Babe Ruth\'s home run record in 1961. Commissioner Ford Frick initially attached an asterisk to the record. Why?', hint:'Frick ruled that Maris needed to break the record in 154 games (Ruth\'s schedule) to be recognized wi', a:'Maris played more games than Ruth\'s 154-game schedule', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Roger_Maris' },
  { q:'The Knicks\' 1994 Finals loss to Houston — which player went 2-for-18 from the field in Game 7?', hint:'John Starks went 2-for-18 (including 0-for-11 from three) in Game 7 against Houston — one of the mos', a:'John Starks', difficulty:2, team:'Knicks', link:'https://en.wikipedia.org/wiki/1994_NBA_Finals' },
  { q:'Dave Winfield\'s contract with the Yankees in 1980 was estimated at $23 million over 10 years due to a cost-of-living escalator. What did Steinbrenner call Winfield, disparaging his postseason performance?', hint:'Steinbrenner called Winfield \"Mr.', a:'Mr. May', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Dave_Winfield' },
  { q:'Who caught the final out of the 1969 World Series as the Mets completed their miracle championship?', hint:'Cleon Jones caught the final out in left field as the Mets defeated the Baltimore Orioles in Game 5.', a:'D', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/1969_World_Series' },
  { q:'Bryan Trottier won the Hart Trophy as NHL MVP in 1979. How many Stanley Cups did he win total as an Islander?', hint:'Trottier won 4 consecutive Stanley Cups with the Islanders (1980-83) and later won 2 more with Pittsburgh — 6 total.', a:'4', difficulty:3, team:'Islanders', link:'https://en.wikipedia.org/wiki/Bryan_Trottier' },
  { q:'The \"Shot Heard \'Round the World\" in 1951 was hit by Bobby Thomson off which Dodgers pitcher?', hint:'Ralph Branca threw the pitch that Thomson hit into the left field seats at the Polo Grounds to win the NL pennant.', a:'Ralph Branca threw the pitch that Thomson hit into', difficulty:2, team:'Giants', link:'https://en.wikipedia.org/wiki/Shot_Heard_%27round_the_World_(baseball)' },
  { q:'Reggie Jackson\'s three home runs in Game 6 of the 1977 World Series came off how many different pitchers?', hint:'Jackson hit each home run off a different pitcher — Burt Hooton, Elias Sosa, and Charlie Hough — and', a:'3', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/1977_World_Series' },
  { q:'Chris Chambliss hit his famous 1976 ALCS walk-off home run against which team, and in what inning?', hint:'Chambliss hit his walk-off homer in the bottom of the 9th against the Kansas City Royals to send the', a:'B', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Chris_Chambliss' },
  { q:'The New York Liberty won their first WNBA championship in 2024. Who did they defeat in the Finals?', hint:'The Liberty defeated the Minnesota Lynx in five games to win the franchise\'s first WNBA title.', a:'Minnesota Lynx', difficulty:2, team:'Liberty', link:'https://en.wikipedia.org/wiki/2024_WNBA_Finals' },
  { q:'Joe DiMaggio\'s 56-game hitting streak began on May 15, 1941. Where did it end, and who stopped it?', hint:'The streak ended July 17, 1941, in Cleveland.', a:'B', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Joe_DiMaggio%27s_56-game_hitting_streak' },
  { q:'The Islanders swept the Edmonton Oilers in the 1983 Stanley Cup Finals. Which future Hall of Famer was the Oilers\' leading scorer that year?', hint:'Gretzky led the Oilers but was held largely in check by the Islanders\' disciplined defensive system.', a:'Wayne Gretzky', difficulty:2, team:'Islanders', link:'https://en.wikipedia.org/wiki/1983_Stanley_Cup_Finals' },
  { q:'Don Larsen\'s perfect game in 1956 was caught by which legendary Yankees catcher?', hint:'Yogi Berra caught Larsen\'s perfect game and the iconic photograph of Berra leaping into Larsen\'s arm', a:'Yogi Berra caught Larsen\'s perfect game and the ic', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Yogi_Berra' },
  { q:'The 2000 World Series was the first Subway Series since 1956. Which Yankees pitcher famously threw a broken bat toward Mike Piazza?', hint:'Roger Clemens fielded a shattered bat and threw it toward Piazza in Game 2 — one of the most controv', a:'Roger Clemens fielded a shattered bat and threw it', difficulty:2, team:'Yankees/Mets', link:'https://en.wikipedia.org/wiki/2000_World_Series' },
  { q:'Adam Wainwright struck out Carlos Beltran looking to end the 2006 NLCS. What type of pitch ended the series?', hint:'Wainwright threw a curveball that broke perfectly across the outside corner, and Beltran froze — one', a:'Wainwright threw a curveball that broke perfectly ', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/2006_National_League_Championship_Series' },
  { q:'Phil Rizzuto called Yankees games for how many years after his playing career?', hint:'Rizzuto broadcast Yankees games from 1957 to 1996 — 40 years in the booth after a playing career tha', a:'40', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Phil_Rizzuto' },
  { q:'The Giants\' \"Helmet Catch\" game ended the Patriots\' bid for a perfect season. What was New England\'s record entering Super Bowl XLII?', hint:'The Patriots were 18-0 entering Super Bowl XLII — 16 regular season wins plus two playoff wins.', a:'18-0', difficulty:2, team:'Giants', link:'https://en.wikipedia.org/wiki/Super_Bowl_XLII' },
  { q:'Before the Yankees purchased the team in 1973, what was the purchase price CBS had paid for the franchise in 1964?', hint:'CBS paid $13.', a:'$13.2 million', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/New_York_Yankees' },
  { q:'What year did the Brooklyn Dodgers play their last game at Ebbets Field before moving to Los Angeles?', hint:'The Dodgers played their final game at Ebbets Field on September 29, 1957, before relocating to Los ', a:'1957', difficulty:3, team:'Dodgers', link:'https://en.wikipedia.org/wiki/Ebbets_Field' },
  { q:'Felix Millan played for the Mets from 1973-77. What team did the Mets acquire him from?', hint:'Millan was acquired from the Atlanta Braves in December 1972.', a:'Millan was acquired from the Atlanta Braves in Dec', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Felix_Mill%C3%A1n' },
  { q:'The New York Rangers were founded in what year — making them one of the NHL\'s \"Original Six\"?', hint:'The Rangers were founded in 1926, one of the six franchises that formed the core of the NHL through ', a:'1926', difficulty:2, team:'Rangers', link:'https://en.wikipedia.org/wiki/New_York_Rangers' },
  { q:'George Steinbrenner was suspended from baseball in 1974 for making illegal campaign contributions. To which presidential candidate?', hint:'Steinbrenner pleaded guilty to making $75,000 in illegal contributions to Richard Nixon\'s 1972 re-election campaign.', a:'Richard Nixon', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/George_Steinbrenner' },
  { q:'Tug McGraw\'s rallying cry helped the 1973 Mets go from last place to the World Series. What was it?', hint:'\"Ya Gotta Believe!\" — delivered by Tug McGraw in the Mets\' clubhouse in August 1973 when they were i', a:'\"Ya Gotta Believe!\"', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Tug_McGraw' },
  { q:'When Steinbrenner was banned from baseball in 1990, GM Gene Michael quietly built the Core Four. Which of the following was NOT drafted or signed during Steinbrenner\'s absence?', hint:'Bernie Williams was actually signed in 1985 — before Steinbrenner\'s 1990 suspension — though Michael', a:'Bernie Williams was actually signed in 1985', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Core_Four' },
  { q:'The Jets beat the Colts in Super Bowl III. What was the final score?', hint:'The Jets won 16-7 — methodically, not dramatically.', a:'16-7', difficulty:3, team:'Jets', link:'https://en.wikipedia.org/wiki/Super_Bowl_III' },
  { q:'The 1969 Mets defeated the Baltimore Orioles in the World Series. The Orioles had won how many games in the regular season?', hint:'Baltimore won 109 games in 1969 — one of the best regular season records in baseball history.', a:'109', difficulty:3, team:'Mets', link:'https://en.wikipedia.org/wiki/1969_World_Series' },
  { q:'Lou Gehrig\'s consecutive games streak ended at 2,130 when he was diagnosed with ALS. On what date did he give his famous farewell speech at Yankee Stadium?', hint:'Gehrig delivered his \"luckiest man\" speech on July 4, 1939 — Lou Gehrig Appreciation Day at Yankee Stadium.', a:'July 4, 1939', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Lou_Gehrig' },
  { q:'The Mets made the 1999 playoffs as an 8th seed — the last before reaching the 2026 Finals. Which team beat them in the NLCS?', hint:'The Braves defeated the Mets 4-2 in the 1999 NLCS.', a:'The Braves defeated the Mets 4-2 in the 1999 NLCS.', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/1999_National_League_Championship_Series' },
  { q:'Dwight Gooden won the 1985 Cy Young Award unanimously. What was his record and ERA that season?', hint:'Gooden went 24-4 with a 1.', a:'24-4, 1.53', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Dwight_Gooden' },
  { q:'Denis Potvin is the only defenseman in NHL history to surpass how many career points with one team?', hint:'Potvin finished his career with 1,052 points — becoming the first defenseman in NHL history to score', a:'1,000', difficulty:3, team:'Islanders', link:'https://en.wikipedia.org/wiki/Denis_Potvin' },
  { q:'The 1994 Rangers won the Stanley Cup in Game 7 against Vancouver. Who scored the Cup-winning goal?', hint:'Mark Messier scored the Cup-winning goal in Game 7 against Vancouver, completing one of the most pre', a:'Mark Messier', difficulty:2, team:'Rangers', link:'https://en.wikipedia.org/wiki/1994_Stanley_Cup_Finals' },
  { q:'The New York Giants won how many NFL Championships before the Super Bowl era?', hint:'The Giants won 4 NFL Championships in the pre-Super Bowl era — 1927, 1934, 1938, and 1956 — in addit', a:'4', difficulty:3, team:'Giants', link:'https://en.wikipedia.org/wiki/New_York_Giants' },
  { q:'In 2022, Aaron Judge broke Roger Maris\'s American League home run record. What was Judge\'s final total?', hint:'Judge hit 62 home runs in 2022 — one more than Maris\'s AL record set in 1961.', a:'62', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Aaron_Judge' },
  { q:'Knicks coach Red Holzman led New York to two championships. What was his most famous coaching philosophy?', hint:'Holzman\'s famous instruction — \"See the ball, hit the open man\" — defined the ball-movement, team-fi', a:'\"See the ball, hit the open man\"', difficulty:2, team:'Knicks', link:'https://en.wikipedia.org/wiki/Red_Holzman' },
  { q:'The Mets traded Tom Seaver to Cincinnati in 1977 in a move widely regarded as the worst in franchise history. What triggered the trade?', hint:'A Dick Young column in the New York Daily News reported the Mets\' insulting contract offer and made ', a:'A Dick Young column in the New York Daily News rep', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Tom_Seaver' },
  { q:'Mariano Rivera\'s cut fastball was nearly unhittable. In which season did he record his career-high 53 saves?', hint:'Rivera set his career high with 53 saves in 2004 — the year the Yankees famously blew a 3-0 ALCS lead to the Red Sox.', a:'2004', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Mariano_Rivera' },
  { q:'Which Mets pitcher threw back-to-back no-hitters in 1969 (which is impossible) — and who actually DOES hold the record for two consecutive no-hitters?', hint:'Johnny Vander Meer of the Cincinnati Reds is the only pitcher in major league history to throw conse', a:'Johnny Vander Meer of the Cincinnati Reds is the o', difficulty:2, team:'Multiple', link:'https://en.wikipedia.org/wiki/Johnny_Vander_Meer' },
  { q:'Billy Martin managed the Yankees how many times total?', hint:'Steinbrenner hired and fired Martin five separate times — 1975-78, 1979, 1983, 1985, and 1988.', a:'5', difficulty:3, team:'Yankees', link:'https://en.wikipedia.org/wiki/Billy_Martin' },
  { q:'The 1986 Mets had one of the most dominant rotations in baseball history. Which starter led the team with 17 wins?', hint:'Bobby Ojeda led the 1986 Mets with 18 wins and a 2.', a:'Bobby Ojeda led the 1986 Mets with 18 wins and a 2', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/Bobby_Ojeda' },
  { q:'The Islanders\' run of four consecutive Cups ended when they were eliminated in the 1984 playoffs. Who beat them?', hint:'The Edmonton Oilers eliminated the Islanders in the 1984 Conference Finals, ending the dynasty at four straight Cups.', a:'Edmonton Oilers', difficulty:2, team:'Islanders', link:'https://en.wikipedia.org/wiki/1984_Stanley_Cup_playoffs' },
  { q:'George Steinbrenner was born on July 4, 1930, in what Ohio city?', hint:'Steinbrenner was born in Rocky River, Ohio — a suburb of Cleveland — and had a complicated relations', a:'Rocky River', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/George_Steinbrenner' },
  { q:'What year did WFAN launch in New York as the first 24-hour all-sports radio station in America?', hint:'WFAN launched July 1, 1987, with Suzyn Waldman as the first voice heard on the station.', a:'1987', difficulty:3, team:'Multiple', link:'https://en.wikipedia.org/wiki/WFAN' },
  { q:'The 2007 Mets collapse is one of the most notorious in baseball history. How many games ahead were they with 17 games left in the season?', hint:'The 2007 Mets led the NL East by 7 games with 17 games to play — and lost the division to the Philli', a:'7 games', difficulty:3, team:'Mets', link:'https://en.wikipedia.org/wiki/2007_New_York_Mets_season' },
  { q:'Endy Chavez made his famous catch in Game 7 of the 2006 NLCS. Whose home run did he rob?', hint:'Chavez leapt above the left field wall to rob Jim Edmonds of a two-run home run in the 6th inning — ', a:'Jim Edmonds', difficulty:2, team:'Mets', link:'https://en.wikipedia.org/wiki/2006_National_League_Championship_Series' },
  { q:'Sam Rosen called Rangers games for 40 years. What was his signature call for a power play goal?', hint:'\"It\'s a power play goal!\" — delivered with contained, precise excitement — became the signature of R', a:'\"It\'s a power play goal!\"', difficulty:2, team:'Rangers', link:'https://en.wikipedia.org/wiki/Sam_Rosen' },
  { q:'Joe Namath set the AFL record for passing yards in 1967. How many did he throw for?', hint:'Namath threw for 4,007 yards in 1967 — the first quarterback in professional football history to sur', a:'4,007', difficulty:3, team:'Jets', link:'https://en.wikipedia.org/wiki/Joe_Namath' },
  { q:'The New York Cosmos signed Pelé in 1975 for a then-record contract. How much was it reported to be worth?', hint:'Pelé\'s contract with the Cosmos was reported to be worth approximately $4.', a:'$4.5 million', difficulty:2, team:'Cosmos', link:'https://en.wikipedia.org/wiki/Pelé' },
  { q:'The Bronx Zoo Yankees of 1977 featured a famous feud between Reggie Jackson and manager Billy Martin. Jackson made a statement about his own importance to the team — what did he say?', hint:'Jackson told Sport magazine \"I\'m the straw that stirs the drink\" — effectively dismissing Thurman Mu', a:'\"I\'m the straw that stirs the drink\"', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Reggie_Jackson' },
  { q:'Whitey Ford is the Yankees\' all-time wins leader with 236 career victories. What was his career winning percentage — the highest ever for any pitcher with 200+ wins?', hint:'Whitey Ford had a career winning percentage of .', a:'.690', difficulty:2, team:'Yankees', link:'https://en.wikipedia.org/wiki/Whitey_Ford' },
  { q:'When the Knicks won the 2026 NBA championship, who did they defeat in the Finals, and in how many games?', hint:'The Knicks defeated the San Antonio Spurs in 5 games — the same franchise that beat the Knicks in th', a:'The Knicks defeated the San Antonio Spurs in 5 gam', difficulty:3, team:'Knicks', link:'https://en.wikipedia.org/wiki/Jalen_Brunson' },
  { q:'The Islanders won their 4th consecutive Stanley Cup in 1983. Which goalie won the Conn Smythe Trophy that year?', hint:'Billy Smith won the Conn Smythe Trophy in 1983 — the same year the Islanders swept the Oilers.', a:'Billy Smith won the Conn Smythe Trophy in 1983', difficulty:2, team:'Islanders', link:'https://en.wikipedia.org/wiki/Billy_Smith_(ice_hockey)' },
];

// Pick trivia question based on day of week difficulty
// Mon(1)/Tue(2) = easy(1), Wed(3)/Thu(4) = medium(2), Fri(5)/Sat(6)/Sun(0) = hard(3)
function getTodayTrivia() {
  const dow = new Date().getDay(); // 0=Sun, 1=Mon...6=Sat
  let targetDiff;
  if (dow === 1 || dow === 2) targetDiff = 1;       // Mon/Tue: easy
  else if (dow === 3 || dow === 4) targetDiff = 2;   // Wed/Thu: medium
  else targetDiff = 3;                                // Fri/Sat/Sun: hard

  // Filter by difficulty, with fallback to any
  let pool = TRIVIA_QUESTIONS.filter(q => q.difficulty === targetDiff);
  if (pool.length === 0) pool = TRIVIA_QUESTIONS;

  // Use date as seed so same question shows all day but changes daily
  // Also avoid showing same team two days in a row
  const today = new Date();
...
function buildEmail(subscriber, scores, todayGames, headlines, glory, trivia, otd, mlbDetails, mlbStandings, yesterdayTrivia, nugget, saturdayPoll, trophyEntry) {
  ...
  const diffLabel = trivia.difficulty === 3 ? '🔥 Saturday Level' : trivia.difficulty === 1 ? '⭐ Monday Level' : '💡 Mid-Week';
  const triviaHtml = '<div style="background:#f5f5ff;border-left:4px solid #5555bb;padding:16px 18px">'
    + '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">'
    + '<div style="font-size:8px;font-weight:900;color:#5555bb;letter-spacing:0.2em;text-transform:uppercase">&#127914; Today&rsquo;s Trivia Question</div>'
    + '<div style="font-size:9px;font-weight:700;color:#888">' + diffLabel + '</div>'
    + '</div>'
    ...
    + (trivia.link ? '<a href="' + trivia.link + '" style="display:inline-block;background:#f0f0ff;color:#5555bb;text-decoration:none;font-size:11px;font-weight:700;padding:10px 16px;border:1px solid #c0c0ff">&#128279; Go Deeper</a>' : '')
    + '</div>'
