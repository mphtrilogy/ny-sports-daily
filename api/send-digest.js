...
const GLORY_MOMENTS = [
  ...
  { year:1927, team:"Yankees", title:"Murderers\' Row Sweeps the World Series", story:"The 1927 Yankees are still considered by many the greatest team in baseball history. Babe Ruth hit 60 home runs that season — a record that stood for 34 years — and the team swept the Pittsburgh Pirates in the World Series. They won 110 games. Nobody else in the American League won more than 91." },
  { year:1928, team:"Yankees", title:"Back-to-Back: Ruth and Gehrig Take the Series Again", story:"The 1928 Yankees swept the Cardinals in four games to win back-to-back World Series titles. Babe Ruth batted .625 and Lou Gehrig batted .545 — the two greatest performances by a pair of teammates in Series history. New York was untouchable." },
  ...
  { year:1941, team:"Yankees", title:"DiMaggio\'s 56 and Another Championship", story:"Joe DiMaggio hit safely in 56 consecutive games in 1941 — a record that has never been approached in the 85 years since. The Yankees won the World Series that October, defeating the Brooklyn Dodgers in five games. The summer of DiMaggio was the summer New York ruled baseball." },
  ...
  { year:1955, team:"Brooklyn Dodgers", title:"\'Next Year\' Finally Arrives in Brooklyn", story:"In 1955, the Brooklyn Dodgers won the only World Series title in franchise history, defeating the New York Yankees in seven games. Sandy Amoros made a running catch in the sixth inning of Game 7 that saved the series. \'Wait till next year\' had been Brooklyn\'s motto for decades. It finally arrived, just two years before the Dodgers left for Los Angeles forever." },
  { year:1956, team:"Yankees", title:"Don Larsen\'s Perfect Game in the World Series", story:"On October 8, 1956, Don Larsen threw the only perfect game in World Series history — 27 batters, 27 outs, against the Brooklyn Dodgers at Yankee Stadium. Larsen was a journeyman pitcher who would finish his career with a losing record. He was perfect for exactly one afternoon, at exactly the right moment, in exactly the right place." },
  ...
  { year:1983, team:"Islanders", title:"Four Straight: Sweeping Gretzky\'s Oilers", story:"The 1983 Islanders swept the Edmonton Oilers — a team that included Gretzky, Messier, Coffey, and Kurri — to win their fourth consecutive Stanley Cup. It was the defining statement of the dynasty. The Oilers would go on to win five championships of their own. The Islanders beat them when it mattered most, in the Finals, in four straight games." },
  { year:1984, team:"Giants", title:"Lawrence Taylor Arrives", story:"By 1984, Lawrence Taylor had already redefined what an outside linebacker was supposed to do. He had won the NFL Defensive Player of the Year in each of his first three seasons. Offensive coordinators were designing entire game plans around the specific problem of not letting Taylor reach their quarterback. The Giants were building something. LT was the reason." },
  ...
  { year:1990, team:"Giants", title:"Norwood\'s Kick Goes Wide Right", story:"The Giants won Super Bowl XXV 20-19 over the Buffalo Bills when Scott Norwood\'s 47-yard field goal attempt sailed wide right as time expired. Ottis Anderson was named MVP at age 34. The Giants had held the ball for 40 minutes and 33 seconds — the most time of possession in Super Bowl history — to neutralize Jim Kelly and the Bills\' no-huddle offense. It is still the most strategically brilliant Super Bowl the franchise has ever played." },
  { year:1991, team:"Rangers", title:"Messier Arrives and Changes Everything", story:"When Mark Messier joined the Rangers from Edmonton in 1991, he brought five Stanley Cup rings, a captain\'s presence, and the specific knowledge of what it took to win. He won the Hart Trophy in his first season. He told his new teammates that the drought was going to end. Three years later, he made it happen." },
  { year:1992, team:"Giants", title:"Phil Simms Era Ends", story:"Phil Simms played his final full season for the Giants in 1990 and his career effectively ended with a broken foot in 1993. He won two Super Bowls, completed the most efficient championship game performance in history, and was never fully appreciated while he played. New York does that sometimes — recognizes greatness only after it\'s gone." },
  { year:1993, team:"Rangers", title:"Messier Scores 50", story:"Mark Messier scored his 50th goal of the 1992-93 season and the Garden crowd gave him a standing ovation that lasted several minutes. He was the captain of a Rangers team that was building toward something the city hadn\'t experienced since 1940. The anticipation was palpable. One more year." },
  ...
  { year:2008, team:"Giants", title:"Eli Manning: Two-Time Super Bowl Champion", story:"Eli Manning won his second Super Bowl MVP in five years in Super Bowl XLVI, defeating the Patriots again 21-17. The Giants had won two Super Bowls in five years, both against the same dynasty, both as underdogs. Manning engineered both comeback victories. New York had doubted him when he arrived. By 2012, there was nothing left to doubt." },
  { year:2015, team:"Mets", title:"The Mets Return to the World Series", story:"The 2015 New York Mets reached the World Series for the first time since 2000, defeating the Chicago Cubs in four games in the NLCS. Jacob deGrom, Noah Syndergaard, Matt Harvey, and Steven Matz formed a rotation that was, for one October, as dominant as any in Mets history. They lost the World Series to the Royals in five games. The rotation\'s promise never fully delivered. But that October was real." },
  { year:2022, team:"Yankees", title:"Aaron Judge Hits 62", story:"On October 4, 2022, Aaron Judge hit his 62nd home run of the season, breaking Roger Maris\'s American League record of 61 that had stood since 1961. Judge had spent the entire summer declining to sign a contract extension, betting on himself. He was right to. He won the AL MVP unanimously. The number 62 is now his, cleanly and without asterisk." },
